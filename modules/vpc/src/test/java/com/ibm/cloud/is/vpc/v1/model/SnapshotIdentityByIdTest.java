...
public class SnapshotIdentityByIdTest {
  ...
  public void testSnapshotIdentityById() throws Throwable {
    SnapshotIdentityById snapshotIdentityByIdModel = new SnapshotIdentityById.Builder()
      ...
      .build();
    assertEquals(snapshotIdentityByIdModel.id(), "r006-f6bfa329-0e36-433f-a3bb-0df632e79263");
    ...
    assertEquals(snapshotIdentityByIdModelNew.id(), "r006-f6bfa329-0e36-433f-a3bb-0df632e79263");
  }
