...
/**
 * Unit test class for the GetShareProfileOptions model.
 */
public class GetShareProfileOptionsTest {
  ...
  public void testGetShareProfileOptionsError() throws Throwable {
    new GetShareProfileOptions.Builder().build();
  }
