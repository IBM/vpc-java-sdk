...
/**
 * Unit test class for the ListShareMountTargetsOptions model.
 */
public class ListShareMountTargetsOptionsTest {
  ...
  public void testListShareMountTargetsOptionsError() throws Throwable {
    new ListShareMountTargetsOptions.Builder().build();
  }
