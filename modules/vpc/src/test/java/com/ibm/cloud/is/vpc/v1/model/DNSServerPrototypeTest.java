...
/**
 * Unit test class for the DNSServerPrototype model.
 */
public class DNSServerPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDNSServerPrototype() throws Throwable {
    ...
    String json = TestUtilities.serialize(dnsServerPrototypeModel);

    DNSServerPrototype dnsServerPrototypeModelNew = TestUtilities.deserialize(json, DNSServerPrototype.class);
    assertTrue(dnsServerPrototypeModelNew instanceof DNSServerPrototype);
