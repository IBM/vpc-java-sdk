...
/**
 * Unit test class for the InstanceTemplateInstanceBySourceSnapshotInstanceTemplateContext model.
 */
public class InstanceTemplateInstanceBySourceSnapshotInstanceTemplateContextTest {
