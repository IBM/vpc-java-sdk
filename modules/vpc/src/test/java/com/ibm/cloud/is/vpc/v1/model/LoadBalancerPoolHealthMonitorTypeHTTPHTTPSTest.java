...
/**
 * Unit test class for the LoadBalancerPoolHealthMonitorTypeHTTPHTTPS model.
 */
public class LoadBalancerPoolHealthMonitorTypeHTTPHTTPSTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerPoolHealthMonitorTypeHTTPHTTPS() throws Throwable {
    LoadBalancerPoolHealthMonitorTypeHTTPHTTPS loadBalancerPoolHealthMonitorTypeHttphttpsModel = new LoadBalancerPoolHealthMonitorTypeHTTPHTTPS();
    assertNull(loadBalancerPoolHealthMonitorTypeHttphttpsModel.getDelay());
