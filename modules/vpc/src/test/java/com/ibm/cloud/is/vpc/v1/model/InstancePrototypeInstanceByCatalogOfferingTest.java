...
public class InstancePrototypeInstanceByCatalogOfferingTest {
  ...
  public void testInstancePrototypeInstanceByCatalogOffering() throws Throwable {
    ...
    InstancePrototypeInstanceByCatalogOffering instancePrototypeInstanceByCatalogOfferingModel = new InstancePrototypeInstanceByCatalogOffering.Builder()
      ...
      .build();
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.availabilityPolicy(), instanceAvailabilityPolicyPrototypeModel);
    ...
    assertEquals(instancePrototypeInstanceByCatalogOfferingModel.volumeAttachments(), java.util.Arrays.asList(volumeAttachmentPrototypeModel));
    ...
    assertEquals(instancePrototypeInstanceByCatalogOfferingModelNew.availabilityPolicy().toString(), instanceAvailabilityPolicyPrototypeModel.toString());
