...
/**
 * Unit test class for the VPNGatewayConnectionRouteMode model.
 */
public class VPNGatewayConnectionRouteModeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testVPNGatewayConnectionRouteMode() throws Throwable {
    VPNGatewayConnectionRouteMode vpnGatewayConnectionRouteModeModel = new VPNGatewayConnectionRouteMode();
    assertNotNull(vpnGatewayConnectionRouteModeModel);
  }
}