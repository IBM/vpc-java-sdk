...
/**
 * Unit test class for the IPsecPolicyConnectionCollection model.
 */
public class IPsecPolicyConnectionCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testIPsecPolicyConnectionCollection() throws Throwable {
    IPsecPolicyConnectionCollection iPsecPolicyConnectionCollectionModel = new IPsecPolicyConnectionCollection();
    assertNull(iPsecPolicyConnectionCollectionModel.getConnections());
    assertNull(iPsecPolicyConnectionCollectionModel.getFirst());
    assertNull(iPsecPolicyConnectionCollectionModel.getLimit());
    assertNull(iPsecPolicyConnectionCollectionModel.getNext());
    assertNull(iPsecPolicyConnectionCollectionModel.getTotalCount());
  }
}