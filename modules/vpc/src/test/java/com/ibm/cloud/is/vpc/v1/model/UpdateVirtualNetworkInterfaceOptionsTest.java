...
/**
 * Unit test class for the UpdateVirtualNetworkInterfaceOptions model.
 */
public class UpdateVirtualNetworkInterfaceOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateVirtualNetworkInterfaceOptions() throws Throwable {
  ...
  public void testUpdateVirtualNetworkInterfaceOptionsError() throws Throwable {
    new UpdateVirtualNetworkInterfaceOptions.Builder().build();
  }
