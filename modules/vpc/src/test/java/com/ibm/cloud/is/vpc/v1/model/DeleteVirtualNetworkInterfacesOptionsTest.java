...
/**
 * Unit test class for the DeleteVirtualNetworkInterfacesOptions model.
 */
public class DeleteVirtualNetworkInterfacesOptionsTest {
  ...
  public void testDeleteVirtualNetworkInterfacesOptionsError() throws Throwable {
    new DeleteVirtualNetworkInterfacesOptions.Builder().build();
  }
