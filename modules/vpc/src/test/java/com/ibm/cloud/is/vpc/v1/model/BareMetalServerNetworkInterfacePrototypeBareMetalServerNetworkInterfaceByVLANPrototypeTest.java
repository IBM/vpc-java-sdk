...
public class BareMetalServerNetworkInterfacePrototypeBareMetalServerNetworkInterfaceByVLANPrototypeTest {
  ...
  public void testBareMetalServerNetworkInterfacePrototypeBareMetalServerNetworkInterfaceByVLANPrototype() throws Throwable {
    ...
    assertEquals(bareMetalServerNetworkInterfacePrototypeBareMetalServerNetworkInterfaceByVlanPrototypeModel.primaryIpv4Address(), "10.0.0.5");
    ...
    assertEquals(bareMetalServerNetworkInterfacePrototypeBareMetalServerNetworkInterfaceByVlanPrototypeModelNew.primaryIpv4Address(), "10.0.0.5");
