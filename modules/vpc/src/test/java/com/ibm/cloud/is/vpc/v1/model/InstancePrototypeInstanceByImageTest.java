...
public class InstancePrototypeInstanceByImageTest {
  ...
  public void testInstancePrototypeInstanceByImage() throws Throwable {
    InstancePrototypeInstanceByImage instancePrototypeInstanceByImageModel = new InstancePrototypeInstanceByImage();
    assertNotNull(instancePrototypeInstanceByImageModel);
  }
}