...
/**
 * Unit test class for the InstanceNetworkAttachmentPrototype model.
 */
public class InstanceNetworkAttachmentPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstanceNetworkAttachmentPrototype() throws Throwable {
    ...
    String json = TestUtilities.serialize(instanceNetworkAttachmentPrototypeModel);
  ...
  public void testInstanceNetworkAttachmentPrototypeError() throws Throwable {
    new InstanceNetworkAttachmentPrototype.Builder().build();
  }
