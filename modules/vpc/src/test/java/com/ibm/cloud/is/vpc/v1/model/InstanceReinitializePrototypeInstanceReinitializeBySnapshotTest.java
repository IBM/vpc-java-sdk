...
/**
 * Unit test class for the InstanceReinitializePrototypeInstanceReinitializeBySnapshot model.
 */
public class InstanceReinitializePrototypeInstanceReinitializeBySnapshotTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstanceReinitializePrototypeInstanceReinitializeBySnapshot() throws Throwable {
    ...
    InstanceReinitializePrototypeInstanceReinitializeBySnapshot instanceReinitializePrototypeInstanceReinitializeBySnapshotModel = new InstanceReinitializePrototypeInstanceReinitializeBySnapshot.Builder()
      ...
      .build();
    assertEquals(instanceReinitializePrototypeInstanceReinitializeBySnapshotModel.defaultTrustedProfile(), instanceDefaultTrustedProfilePrototypeModel);
    assertEquals(instanceReinitializePrototypeInstanceReinitializeBySnapshotModel.keys(), java.util.Arrays.asList(keyIdentityModel));
    assertEquals(instanceReinitializePrototypeInstanceReinitializeBySnapshotModel.userData(), "[...]");
    assertEquals(instanceReinitializePrototypeInstanceReinitializeBySnapshotModel.bootVolumeAttachment(), volumeAttachmentPrototypeInstanceBySourceSnapshotContextModel);

    String json = TestUtilities.serialize(instanceReinitializePrototypeInstanceReinitializeBySnapshotModel);

    InstanceReinitializePrototypeInstanceReinitializeBySnapshot instanceReinitializePrototypeInstanceReinitializeBySnapshotModelNew = TestUtilities.deserialize(json, InstanceReinitializePrototypeInstanceReinitializeBySnapshot.class);
    assertTrue(instanceReinitializePrototypeInstanceReinitializeBySnapshotModelNew instanceof InstanceReinitializePrototypeInstanceReinitializeBySnapshot);
    assertEquals(instanceReinitializePrototypeInstanceReinitializeBySnapshotModelNew.defaultTrustedProfile().toString(), instanceDefaultTrustedProfilePrototypeModel.toString());
    assertEquals(instanceReinitializePrototypeInstanceReinitializeBySnapshotModelNew.userData(), "[...]");
    assertEquals(instanceReinitializePrototypeInstanceReinitializeBySnapshotModelNew.bootVolumeAttachment().toString(), volumeAttachmentPrototypeInstanceBySourceSnapshotContextModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testInstanceReinitializePrototypeInstanceReinitializeBySnapshotError() throws Throwable {
    new InstanceReinitializePrototypeInstanceReinitializeBySnapshot.Builder().build();
  }
