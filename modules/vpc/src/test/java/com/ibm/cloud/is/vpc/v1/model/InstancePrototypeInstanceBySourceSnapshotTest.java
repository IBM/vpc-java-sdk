...
public class InstancePrototypeInstanceBySourceSnapshotTest {
  ...
  public void testInstancePrototypeInstanceBySourceSnapshot() throws Throwable {
    InstancePrototypeInstanceBySourceSnapshot instancePrototypeInstanceBySourceSnapshotModel = new InstancePrototypeInstanceBySourceSnapshot();
    assertNotNull(instancePrototypeInstanceBySourceSnapshotModel);
  }
}