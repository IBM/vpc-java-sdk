...
/**
 * Unit test class for the BackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototype model.
 */
public class BackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototype() throws Throwable {
    ...
    BackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototype backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModel = new BackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototype.Builder()
      ...
      .matchResourceType("share")
      .build();
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModel.matchUserTags(), java.util.Arrays.asList("my-daily-backup-policy"));
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModel.name(), "my-backup-policy");
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModel.plans(), java.util.Arrays.asList(backupPolicyPlanPrototypeModel));
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModel.resourceGroup(), resourceGroupIdentityModel);
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModel.scope(), backupPolicyScopePrototypeModel);
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModel.matchResourceType(), "share");

    String json = TestUtilities.serialize(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModel);

    BackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototype backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModelNew = TestUtilities.deserialize(json, BackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototype.class);
    assertTrue(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModelNew instanceof BackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototype);
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModelNew.name(), "my-backup-policy");
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModelNew.resourceGroup().toString(), resourceGroupIdentityModel.toString());
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModelNew.scope().toString(), backupPolicyScopePrototypeModel.toString());
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeModelNew.matchResourceType(), "share");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testBackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototypeError() throws Throwable {
    new BackupPolicyPrototypeBackupPolicyMatchResourceTypeSharePrototype.Builder().build();
  }
