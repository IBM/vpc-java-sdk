...
public class KeyIdentityByCRNTest {
  ...
  public void testKeyIdentityByCRN() throws Throwable {
    KeyIdentityByCRN keyIdentityByCrnModel = new KeyIdentityByCRN.Builder()
      ...
      .build();
    assertEquals(keyIdentityByCrnModel.crn(), "crn:v1:bluemix:public:is:us-south:a/aa2432b1fa4d4ace891e9b80fc104e34::key:r006-82679077-ac3b-4c10-be16-63e9c21f0f45");
    ...
    assertEquals(keyIdentityByCrnModelNew.crn(), "crn:v1:bluemix:public:is:us-south:a/aa2432b1fa4d4ace891e9b80fc104e34::key:r006-82679077-ac3b-4c10-be16-63e9c21f0f45");
  }
