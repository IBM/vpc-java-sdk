...
/**
 * Unit test class for the LoadBalancerPoolServerAuthenticationPrototype model.
 */
public class LoadBalancerPoolServerAuthenticationPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerPoolServerAuthenticationPrototype() throws Throwable {
    ...
    String json = TestUtilities.serialize(loadBalancerPoolServerAuthenticationPrototypeModel);

    LoadBalancerPoolServerAuthenticationPrototype loadBalancerPoolServerAuthenticationPrototypeModelNew = TestUtilities.deserialize(json, LoadBalancerPoolServerAuthenticationPrototype.class);
    assertTrue(loadBalancerPoolServerAuthenticationPrototypeModelNew instanceof LoadBalancerPoolServerAuthenticationPrototype);
    assertEquals(loadBalancerPoolServerAuthenticationPrototypeModelNew.certificateAuthority().toString(), certificateInstanceIdentityModel.toString());
    assertEquals(loadBalancerPoolServerAuthenticationPrototypeModelNew.verifyCertificate(), Boolean.valueOf(false));
  }
}