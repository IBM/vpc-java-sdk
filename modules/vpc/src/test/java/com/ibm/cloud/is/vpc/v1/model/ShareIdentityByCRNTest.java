...
public class ShareIdentityByCRNTest {
  ...
  public void testShareIdentityByCRN() throws Throwable {
    ShareIdentityByCRN shareIdentityByCrnModel = new ShareIdentityByCRN.Builder()
      ...
      .build();
    assertEquals(shareIdentityByCrnModel.crn(), "crn:v1:bluemix:public:is:us-south-1:a/aa2432b1fa4d4ace891e9b80fc104e34::share:r006-0fe9e5d8-0a4d-4818-96ec-e99708644a58");
    ...
    assertEquals(shareIdentityByCrnModelNew.crn(), "crn:v1:bluemix:public:is:us-south-1:a/aa2432b1fa4d4ace891e9b80fc104e34::share:r006-0fe9e5d8-0a4d-4818-96ec-e99708644a58");
  }
