...
public class BareMetalServerNetworkInterfacePrototypeBareMetalServerNetworkInterfaceByPCIPrototypeTest {
  ...
  public void testBareMetalServerNetworkInterfacePrototypeBareMetalServerNetworkInterfaceByPCIPrototype() throws Throwable {
    ...
    assertEquals(bareMetalServerNetworkInterfacePrototypeBareMetalServerNetworkInterfaceByPciPrototypeModel.primaryIpv4Address(), "10.0.0.5");
    ...
    assertEquals(bareMetalServerNetworkInterfacePrototypeBareMetalServerNetworkInterfaceByPciPrototypeModelNew.primaryIpv4Address(), "10.0.0.5");
