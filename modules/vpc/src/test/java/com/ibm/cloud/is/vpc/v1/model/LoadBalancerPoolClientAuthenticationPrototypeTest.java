...
/**
 * Unit test class for the LoadBalancerPoolClientAuthenticationPrototype model.
 */
public class LoadBalancerPoolClientAuthenticationPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerPoolClientAuthenticationPrototype() throws Throwable {
    ...
    String json = TestUtilities.serialize(loadBalancerPoolClientAuthenticationPrototypeModel);

    LoadBalancerPoolClientAuthenticationPrototype loadBalancerPoolClientAuthenticationPrototypeModelNew = TestUtilities.deserialize(json, LoadBalancerPoolClientAuthenticationPrototype.class);
    assertTrue(loadBalancerPoolClientAuthenticationPrototypeModelNew instanceof LoadBalancerPoolClientAuthenticationPrototype);
    assertEquals(loadBalancerPoolClientAuthenticationPrototypeModelNew.certificateInstance().toString(), certificateInstanceIdentityModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testLoadBalancerPoolClientAuthenticationPrototypeError() throws Throwable {
    new LoadBalancerPoolClientAuthenticationPrototype.Builder().build();
  }
