...
/**
 * Unit test class for the LoadBalancerPoolIdentityLoadBalancerPoolIdentityById model.
 */
public class LoadBalancerPoolIdentityLoadBalancerPoolIdentityByIdTest {
  ...
  public void testLoadBalancerPoolIdentityLoadBalancerPoolIdentityByIdError() throws Throwable {
    new LoadBalancerPoolIdentityLoadBalancerPoolIdentityById.Builder().build();
  }
