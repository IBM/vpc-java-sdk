...
public class InstancePrototypeInstanceByVolumeTest {
  ...
  public void testInstancePrototypeInstanceByVolume() throws Throwable {
    InstancePrototypeInstanceByVolume instancePrototypeInstanceByVolumeModel = new InstancePrototypeInstanceByVolume();
    assertNotNull(instancePrototypeInstanceByVolumeModel);
  }
}