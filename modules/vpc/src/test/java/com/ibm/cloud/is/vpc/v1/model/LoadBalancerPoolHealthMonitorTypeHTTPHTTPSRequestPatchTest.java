...
/**
 * Unit test class for the LoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPatch model.
 */
public class LoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPatchTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPatch() throws Throwable {
    ...
    String json = TestUtilities.serialize(loadBalancerPoolHealthMonitorTypeHttphttpsRequestPatchModel);

    LoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPatch loadBalancerPoolHealthMonitorTypeHttphttpsRequestPatchModelNew = TestUtilities.deserialize(json, LoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPatch.class);
    assertTrue(loadBalancerPoolHealthMonitorTypeHttphttpsRequestPatchModelNew instanceof LoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPatch);
    assertEquals(loadBalancerPoolHealthMonitorTypeHttphttpsRequestPatchModelNew.body(), "ACTIVE");
    assertEquals(loadBalancerPoolHealthMonitorTypeHttphttpsRequestPatchModelNew.method(), "get");
  }
}