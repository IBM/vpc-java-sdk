...
public class ReservationIdentityByCRNTest {
  ...
  public void testReservationIdentityByCRN() throws Throwable {
    ReservationIdentityByCRN reservationIdentityByCrnModel = new ReservationIdentityByCRN.Builder()
      ...
      .build();
    assertEquals(reservationIdentityByCrnModel.crn(), "crn:v1:bluemix:public:is:us-south:a/123456::reservation:7187-ba49df72-37b8-43ac-98da-f8e029de0e63");
    ...
    assertEquals(reservationIdentityByCrnModelNew.crn(), "crn:v1:bluemix:public:is:us-south:a/123456::reservation:7187-ba49df72-37b8-43ac-98da-f8e029de0e63");
  }
