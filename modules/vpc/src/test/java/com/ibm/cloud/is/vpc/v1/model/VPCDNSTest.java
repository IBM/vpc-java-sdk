...
/**
 * Unit test class for the VPCDNS model.
 */
public class VPCDNSTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVPCDNS() throws Throwable {
    VPCDNS vpcdnsModel = new VPCDNS();
    assertNull(vpcdnsModel.isEnableHub());
    assertNull(vpcdnsModel.getResolutionBindingCount());
    assertNull(vpcdnsModel.getResolver());
  }
}