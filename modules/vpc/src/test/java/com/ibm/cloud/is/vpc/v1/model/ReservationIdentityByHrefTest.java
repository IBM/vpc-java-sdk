...
/**
 * Unit test class for the ReservationIdentityByHref model.
 */
public class ReservationIdentityByHrefTest {
  ...
  public void testReservationIdentityByHrefError() throws Throwable {
    new ReservationIdentityByHref.Builder().build();
  }
