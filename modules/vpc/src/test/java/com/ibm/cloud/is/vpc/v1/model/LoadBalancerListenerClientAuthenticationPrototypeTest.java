...
/**
 * Unit test class for the LoadBalancerListenerClientAuthenticationPrototype model.
 */
public class LoadBalancerListenerClientAuthenticationPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerListenerClientAuthenticationPrototype() throws Throwable {
    ...
    LoadBalancerListenerClientAuthenticationPrototype loadBalancerListenerClientAuthenticationPrototypeModel = new LoadBalancerListenerClientAuthenticationPrototype.Builder()
      ...
      .build();
    assertEquals(loadBalancerListenerClientAuthenticationPrototypeModel.certificateAuthority(), certificateInstanceIdentityModel);
    assertEquals(loadBalancerListenerClientAuthenticationPrototypeModel.certificateRevocationList(), "-----BEGIN X509 CRL-----\\ng5cWHgYcNnzhUatKodvzZizAOVGRR7UFg42O4ylhxDVe\n-----END X509 CRL-----\n");

    String json = TestUtilities.serialize(loadBalancerListenerClientAuthenticationPrototypeModel);

    LoadBalancerListenerClientAuthenticationPrototype loadBalancerListenerClientAuthenticationPrototypeModelNew = TestUtilities.deserialize(json, LoadBalancerListenerClientAuthenticationPrototype.class);
    assertTrue(loadBalancerListenerClientAuthenticationPrototypeModelNew instanceof LoadBalancerListenerClientAuthenticationPrototype);
    assertEquals(loadBalancerListenerClientAuthenticationPrototypeModelNew.certificateAuthority().toString(), certificateInstanceIdentityModel.toString());
    assertEquals(loadBalancerListenerClientAuthenticationPrototypeModelNew.certificateRevocationList(), "-----BEGIN X509 CRL-----\\ng5cWHgYcNnzhUatKodvzZizAOVGRR7UFg42O4ylhxDVe\n-----END X509 CRL-----\n");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testLoadBalancerListenerClientAuthenticationPrototypeError() throws Throwable {
    new LoadBalancerListenerClientAuthenticationPrototype.Builder().build();
  }
