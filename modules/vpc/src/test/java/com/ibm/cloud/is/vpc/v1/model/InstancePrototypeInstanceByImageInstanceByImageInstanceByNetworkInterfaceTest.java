...
/**
 * Unit test class for the InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface model.
 */
public class InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface() throws Throwable {
    ...
    InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel = new InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface.Builder()
      ...
      .build();
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.availability(), instanceAvailabilityPrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.availabilityPolicy(), instanceAvailabilityPolicyPrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.clusterNetworkAttachments(), java.util.Arrays.asList(instanceClusterNetworkAttachmentPrototypeInstanceContextModel));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.confidentialComputeMode(), "disabled");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.defaultTrustedProfile(), instanceDefaultTrustedProfilePrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.enableSecureBoot(), Boolean.valueOf(true));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.keys(), java.util.Arrays.asList(keyIdentityModel));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.metadataService(), instanceMetadataServicePrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.name(), "my-instance");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.placementTarget(), instancePlacementTargetPrototypeModel);
    ...
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.volumeAttachments(), java.util.Arrays.asList(volumeAttachmentPrototypeModel));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.volumeBandwidthQosMode(), "pooled");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.vpc(), vpcIdentityModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.bootVolumeAttachment(), volumeAttachmentPrototypeInstanceByImageContextModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.image(), imageIdentityModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.zone(), zoneIdentityModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.networkInterfaces(), java.util.Arrays.asList(networkInterfacePrototypeModel));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel.primaryNetworkInterface(), networkInterfacePrototypeModel);

    String json = TestUtilities.serialize(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModel);

    InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew = TestUtilities.deserialize(json, InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface.class);
    assertTrue(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew instanceof InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.availability().toString(), instanceAvailabilityPrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.availabilityPolicy().toString(), instanceAvailabilityPolicyPrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.confidentialComputeMode(), "disabled");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.defaultTrustedProfile().toString(), instanceDefaultTrustedProfilePrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.enableSecureBoot(), Boolean.valueOf(true));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.metadataService().toString(), instanceMetadataServicePrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.name(), "my-instance");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.placementTarget().toString(), instancePlacementTargetPrototypeModel.toString());
    ...
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.volumeBandwidthQosMode(), "pooled");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.vpc().toString(), vpcIdentityModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.bootVolumeAttachment().toString(), volumeAttachmentPrototypeInstanceByImageContextModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.image().toString(), imageIdentityModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.zone().toString(), zoneIdentityModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceModelNew.primaryNetworkInterface().toString(), networkInterfacePrototypeModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testInstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterfaceError() throws Throwable {
    new InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface.Builder().build();
  }
