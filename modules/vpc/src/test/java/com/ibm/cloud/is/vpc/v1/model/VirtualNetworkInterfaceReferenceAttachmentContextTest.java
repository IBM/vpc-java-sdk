...
/**
 * Unit test class for the VirtualNetworkInterfaceReferenceAttachmentContext model.
 */
public class VirtualNetworkInterfaceReferenceAttachmentContextTest {
  ...
  public void testVirtualNetworkInterfaceReferenceAttachmentContext() throws Throwable {
    ...
    assertNull(virtualNetworkInterfaceReferenceAttachmentContextModel.getResourceType());
  }
}