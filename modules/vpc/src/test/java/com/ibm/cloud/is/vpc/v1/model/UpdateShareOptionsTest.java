...
/**
 * Unit test class for the UpdateShareOptions model.
 */
public class UpdateShareOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateShareOptions() throws Throwable {
  ...
  public void testUpdateShareOptionsError() throws Throwable {
    new UpdateShareOptions.Builder().build();
  }
