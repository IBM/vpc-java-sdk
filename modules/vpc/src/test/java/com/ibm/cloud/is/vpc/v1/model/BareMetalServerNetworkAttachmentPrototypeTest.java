...
/**
 * Unit test class for the BareMetalServerNetworkAttachmentPrototype model.
 */
public class BareMetalServerNetworkAttachmentPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testBareMetalServerNetworkAttachmentPrototype() throws Throwable {
    BareMetalServerNetworkAttachmentPrototype bareMetalServerNetworkAttachmentPrototypeModel = new BareMetalServerNetworkAttachmentPrototype();
    assertNotNull(bareMetalServerNetworkAttachmentPrototypeModel);
  }
}