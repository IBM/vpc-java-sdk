...
public class InstanceTemplatePrototypeInstanceTemplateBySourceTemplateTest {
  ...
  public void testInstanceTemplatePrototypeInstanceTemplateBySourceTemplate() throws Throwable {
    ...
    InstanceTemplatePrototypeInstanceTemplateBySourceTemplate instanceTemplatePrototypeInstanceTemplateBySourceTemplateModel = new InstanceTemplatePrototypeInstanceTemplateBySourceTemplate.Builder()
      ...
      .build();
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModel.availability(), instanceAvailabilityPrototypeModel);
    ...
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModel.threadsPerCore(), Long.valueOf("1"));
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModel.totalVolumeBandwidth(), Long.valueOf("500"));
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModel.userData(), "[...]");
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModel.vcpu(), instanceVcpuPrototypeModel);
    ...
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModel.volumeBandwidthQosMode(), "pooled");
    ...
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModelNew.availability().toString(), instanceAvailabilityPrototypeModel.toString());
    ...
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModelNew.threadsPerCore(), Long.valueOf("1"));
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModelNew.totalVolumeBandwidth(), Long.valueOf("500"));
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModelNew.userData(), "[...]");
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModelNew.vcpu().toString(), instanceVcpuPrototypeModel.toString());
    assertEquals(instanceTemplatePrototypeInstanceTemplateBySourceTemplateModelNew.volumeBandwidthQosMode(), "pooled");
