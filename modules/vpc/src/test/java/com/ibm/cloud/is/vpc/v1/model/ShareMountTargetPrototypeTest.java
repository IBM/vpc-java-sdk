...
/**
 * Unit test class for the ShareMountTargetPrototype model.
 */
public class ShareMountTargetPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testShareMountTargetPrototype() throws Throwable {
    ShareMountTargetPrototype shareMountTargetPrototypeModel = new ShareMountTargetPrototype();
    assertNotNull(shareMountTargetPrototypeModel);
  }
}