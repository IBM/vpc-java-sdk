...
/**
 * Unit test class for the LoadBalancerPoolFailsafePolicyPatch model.
 */
public class LoadBalancerPoolFailsafePolicyPatchTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerPoolFailsafePolicyPatch() throws Throwable {
    ...
    String json = TestUtilities.serialize(loadBalancerPoolFailsafePolicyPatchModel);

    LoadBalancerPoolFailsafePolicyPatch loadBalancerPoolFailsafePolicyPatchModelNew = TestUtilities.deserialize(json, LoadBalancerPoolFailsafePolicyPatch.class);
    assertTrue(loadBalancerPoolFailsafePolicyPatchModelNew instanceof LoadBalancerPoolFailsafePolicyPatch);
    assertEquals(loadBalancerPoolFailsafePolicyPatchModelNew.action(), "forward");
    assertEquals(loadBalancerPoolFailsafePolicyPatchModelNew.target().toString(), loadBalancerPoolFailsafePolicyTargetPatchModel.toString());
  }
}