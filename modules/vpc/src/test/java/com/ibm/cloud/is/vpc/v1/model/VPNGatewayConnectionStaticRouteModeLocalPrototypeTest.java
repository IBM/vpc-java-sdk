...
/**
 * Unit test class for the VPNGatewayConnectionStaticRouteModeLocalPrototype model.
 */
public class VPNGatewayConnectionStaticRouteModeLocalPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVPNGatewayConnectionStaticRouteModeLocalPrototype() throws Throwable {
    ...
    String json = TestUtilities.serialize(vpnGatewayConnectionStaticRouteModeLocalPrototypeModel);

    VPNGatewayConnectionStaticRouteModeLocalPrototype vpnGatewayConnectionStaticRouteModeLocalPrototypeModelNew = TestUtilities.deserialize(json, VPNGatewayConnectionStaticRouteModeLocalPrototype.class);
    assertTrue(vpnGatewayConnectionStaticRouteModeLocalPrototypeModelNew instanceof VPNGatewayConnectionStaticRouteModeLocalPrototype);
  }
}