...
/**
 * Unit test class for the FailoverShareOptions model.
 */
public class FailoverShareOptionsTest {
  ...
  public void testFailoverShareOptionsError() throws Throwable {
    new FailoverShareOptions.Builder().build();
  }
