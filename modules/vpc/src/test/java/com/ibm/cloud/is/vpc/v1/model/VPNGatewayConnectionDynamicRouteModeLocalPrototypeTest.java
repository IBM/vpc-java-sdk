...
/**
 * Unit test class for the VPNGatewayConnectionDynamicRouteModeLocalPrototype model.
 */
public class VPNGatewayConnectionDynamicRouteModeLocalPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVPNGatewayConnectionDynamicRouteModeLocalPrototype() throws Throwable {
    ...
    String json = TestUtilities.serialize(vpnGatewayConnectionDynamicRouteModeLocalPrototypeModel);

    VPNGatewayConnectionDynamicRouteModeLocalPrototype vpnGatewayConnectionDynamicRouteModeLocalPrototypeModelNew = TestUtilities.deserialize(json, VPNGatewayConnectionDynamicRouteModeLocalPrototype.class);
    assertTrue(vpnGatewayConnectionDynamicRouteModeLocalPrototypeModelNew instanceof VPNGatewayConnectionDynamicRouteModeLocalPrototype);
  }
}