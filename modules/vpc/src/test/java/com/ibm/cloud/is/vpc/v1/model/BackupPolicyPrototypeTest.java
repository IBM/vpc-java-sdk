...
/**
 * Unit test class for the BackupPolicyPrototype model.
 */
public class BackupPolicyPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testBackupPolicyPrototype() throws Throwable {
    BackupPolicyPrototype backupPolicyPrototypeModel = new BackupPolicyPrototype();
    assertNotNull(backupPolicyPrototypeModel);
  }
}