...
public class InstancePrototypeInstanceBySourceTemplateTest {
  ...
  public void testInstancePrototypeInstanceBySourceTemplate() throws Throwable {
    ...
    InstancePrototypeInstanceBySourceTemplate instancePrototypeInstanceBySourceTemplateModel = new InstancePrototypeInstanceBySourceTemplate.Builder()
      ...
      .build();
    assertEquals(instancePrototypeInstanceBySourceTemplateModel.availability(), instanceAvailabilityPrototypeModel);
    ...
    assertEquals(instancePrototypeInstanceBySourceTemplateModel.volumeBandwidthQosMode(), "pooled");
    ...
    assertEquals(instancePrototypeInstanceBySourceTemplateModelNew.availability().toString(), instanceAvailabilityPrototypeModel.toString());
    ...
    assertEquals(instancePrototypeInstanceBySourceTemplateModelNew.volumeBandwidthQosMode(), "pooled");
    ...
    assertEquals(instancePrototypeInstanceBySourceTemplateModelNew.primaryNetworkAttachment().toString(), instanceNetworkAttachmentPrototypeModel.toString());
