...
/**
 * Unit test class for the BareMetalServerPrototypeBareMetalServerByNetworkAttachment model.
 */
public class BareMetalServerPrototypeBareMetalServerByNetworkAttachmentTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBareMetalServerPrototypeBareMetalServerByNetworkAttachment() throws Throwable {
    ...
    assertEquals(bareMetalServerPrototypeBareMetalServerByNetworkAttachmentModel.metadataService(), bareMetalServerMetadataServicePrototypeModel);
    ...
    assertEquals(bareMetalServerPrototypeBareMetalServerByNetworkAttachmentModel.zone(), zoneIdentityModel);
    assertEquals(bareMetalServerPrototypeBareMetalServerByNetworkAttachmentModel.networkAttachments(), java.util.Arrays.asList(bareMetalServerNetworkAttachmentPrototypeModel));
    assertEquals(bareMetalServerPrototypeBareMetalServerByNetworkAttachmentModel.primaryNetworkAttachment(), bareMetalServerPrimaryNetworkAttachmentPrototypeModel);

    String json = TestUtilities.serialize(bareMetalServerPrototypeBareMetalServerByNetworkAttachmentModel);
    ...
    assertEquals(bareMetalServerPrototypeBareMetalServerByNetworkAttachmentModelNew.metadataService().toString(), bareMetalServerMetadataServicePrototypeModel.toString());
  ...
  public void testBareMetalServerPrototypeBareMetalServerByNetworkAttachmentError() throws Throwable {
    new BareMetalServerPrototypeBareMetalServerByNetworkAttachment.Builder().build();
  }
