...
/**
 * Unit test class for the BareMetalServerPrimaryNetworkAttachmentPrototype model.
 */
public class BareMetalServerPrimaryNetworkAttachmentPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testBareMetalServerPrimaryNetworkAttachmentPrototype() throws Throwable {
    BareMetalServerPrimaryNetworkAttachmentPrototype bareMetalServerPrimaryNetworkAttachmentPrototypeModel = new BareMetalServerPrimaryNetworkAttachmentPrototype();
    assertNotNull(bareMetalServerPrimaryNetworkAttachmentPrototypeModel);
  }
}