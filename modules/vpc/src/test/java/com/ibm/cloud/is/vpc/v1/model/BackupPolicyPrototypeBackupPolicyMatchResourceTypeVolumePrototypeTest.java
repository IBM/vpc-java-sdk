...
/**
 * Unit test class for the BackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototype model.
 */
public class BackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testBackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototype() throws Throwable {
    ...
    BackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototype backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModel = new BackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototype.Builder()
      ...
      .build();
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModel.matchUserTags(), java.util.Arrays.asList("my-daily-backup-policy"));
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModel.name(), "my-backup-policy");
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModel.plans(), java.util.Arrays.asList(backupPolicyPlanPrototypeModel));
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModel.resourceGroup(), resourceGroupIdentityModel);
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModel.scope(), backupPolicyScopePrototypeModel);
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModel.matchResourceType(), "volume");

    String json = TestUtilities.serialize(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModel);

    BackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototype backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModelNew = TestUtilities.deserialize(json, BackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototype.class);
    assertTrue(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModelNew instanceof BackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototype);
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModelNew.name(), "my-backup-policy");
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModelNew.resourceGroup().toString(), resourceGroupIdentityModel.toString());
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModelNew.scope().toString(), backupPolicyScopePrototypeModel.toString());
    assertEquals(backupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeModelNew.matchResourceType(), "volume");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testBackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototypeError() throws Throwable {
    new BackupPolicyPrototypeBackupPolicyMatchResourceTypeVolumePrototype.Builder().build();
  }
