...
import com.ibm.cloud.is.vpc.v1.model.AddVpnGatewayAdvertisedCidrOptions;
...
import com.ibm.cloud.is.vpc.v1.model.BackupPolicyJobReference;
...
import com.ibm.cloud.is.vpc.v1.model.BareMetalServerCapacitiesPager;
import com.ibm.cloud.is.vpc.v1.model.BareMetalServerCapacity;
...
import com.ibm.cloud.is.vpc.v1.model.DeleteEndpointGatewayResourceBindingOptions;
...
import com.ibm.cloud.is.vpc.v1.model.EndpointGatewayResourceBindingCollection;
import com.ibm.cloud.is.vpc.v1.model.EndpointGatewayResourceBindingLifecycleReason;
import com.ibm.cloud.is.vpc.v1.model.EndpointGatewayResourceBindingPatch;
import com.ibm.cloud.is.vpc.v1.model.EndpointGatewayResourceBindingTarget;
import com.ibm.cloud.is.vpc.v1.model.EndpointGatewayResourceBindingTargetCRN;
import com.ibm.cloud.is.vpc.v1.model.EndpointGatewayResourceBindingTargetPrototype;
...
import com.ibm.cloud.is.vpc.v1.model.EndpointGatewayResourceBindingsPager;
...
import com.ibm.cloud.is.vpc.v1.model.GetEndpointGatewayResourceBindingOptions;
...
import com.ibm.cloud.is.vpc.v1.model.GetVpnGatewayServiceConnectionOptions;
...
import com.ibm.cloud.is.vpc.v1.model.ImageBareMetalServerProfileCollection;
import com.ibm.cloud.is.vpc.v1.model.ImageBareMetalServerProfilesPager;
...
import com.ibm.cloud.is.vpc.v1.model.ImageInstanceProfileCollection;
import com.ibm.cloud.is.vpc.v1.model.ImageInstanceProfilesPager;
...
import com.ibm.cloud.is.vpc.v1.model.InstanceGroupManagerActionPrototypeScheduledActionPrototypeByCronSpecWithManager;
...
import com.ibm.cloud.is.vpc.v1.model.InstanceProfileVolumeBandwidthQoSModes;
import com.ibm.cloud.is.vpc.v1.model.InstanceProfileVolumeBandwidthQoSModesDependent;
...
import com.ibm.cloud.is.vpc.v1.model.InstanceProfilesPager;
...
import com.ibm.cloud.is.vpc.v1.model.InstanceReinitializePrototype;
import com.ibm.cloud.is.vpc.v1.model.InstanceReinitializePrototypeInstanceReinitializeByImage;
import com.ibm.cloud.is.vpc.v1.model.InstanceReinitializePrototypeInstanceReinitializeBySnapshot;
...
import com.ibm.cloud.is.vpc.v1.model.InstanceSoftwareAttachmentCatalogOffering;
import com.ibm.cloud.is.vpc.v1.model.InstanceSoftwareAttachmentCollection;
import com.ibm.cloud.is.vpc.v1.model.InstanceSoftwareAttachmentEntitlement;
import com.ibm.cloud.is.vpc.v1.model.InstanceSoftwareAttachmentEntitlementLicensedSoftware;
import com.ibm.cloud.is.vpc.v1.model.InstanceSoftwareAttachmentEntitlementLicensedSoftwareVendor;
import com.ibm.cloud.is.vpc.v1.model.InstanceSoftwareAttachmentLifecycleReason;
import com.ibm.cloud.is.vpc.v1.model.InstanceSoftwareAttachmentOfferingInstance;
import com.ibm.cloud.is.vpc.v1.model.InstanceSoftwareAttachmentPatch;
...
import com.ibm.cloud.is.vpc.v1.model.ListEndpointGatewayResourceBindingsOptions;
...
import com.ibm.cloud.is.vpc.v1.model.ListImageBareMetalServerProfilesOptions;
...
import com.ibm.cloud.is.vpc.v1.model.ListSnapshotInstanceProfilesOptions;
...
import com.ibm.cloud.is.vpc.v1.model.ListVpnGatewayAdvertisedCidrsOptions;
...
import com.ibm.cloud.is.vpc.v1.model.ListVpnGatewayServiceConnectionsOptions;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerListenerClientAuthentication;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerListenerClientAuthenticationCertificateAuthorityPatch;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerListenerClientAuthenticationPrototype;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolClientAuthentication;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPrototype;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPrototypeLoadBalancerPoolHealthMonitorTypeHTTPHTTPSRequestPostPrototype;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolMemberTargetFQDN;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolMemberTargetIPNotReservedIP;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolMemberTargetPrototypeReservedIPIdentity;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolMemberTargetPrototypeReservedIPIdentityByHref;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolMemberTargetPrototypeReservedIPIdentityById;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerPoolServerAuthentication;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileAdvancedHealthCheckSupported;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileAdvancedHealthCheckSupportedDependent;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileAdvancedHealthCheckSupportedFixed;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileAsymmetricRoutingSupported;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileAsymmetricRoutingSupportedDependent;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileFQDNSupported;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileFQDNSupportedDependent;
...
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileMtlsSupported;
import com.ibm.cloud.is.vpc.v1.model.LoadBalancerProfileMtlsSupportedDependent;
...
import com.ibm.cloud.is.vpc.v1.model.NetworkACLRuleItemNetworkACLRuleProtocolAny;
import com.ibm.cloud.is.vpc.v1.model.NetworkACLRuleItemNetworkACLRuleProtocolICMP;
import com.ibm.cloud.is.vpc.v1.model.NetworkACLRuleItemNetworkACLRuleProtocolICMPTCPUDP;
import com.ibm.cloud.is.vpc.v1.model.NetworkACLRuleItemNetworkACLRuleProtocolIndividual;
import com.ibm.cloud.is.vpc.v1.model.NetworkACLRuleItemNetworkACLRuleProtocolTCPUDP;
import com.ibm.cloud.is.vpc.v1.model.NetworkACLRuleNetworkACLRuleProtocolAny;
import com.ibm.cloud.is.vpc.v1.model.NetworkACLRuleNetworkACLRuleProtocolICMP;
import com.ibm.cloud.is.vpc.v1.model.NetworkACLRuleNetworkACLRuleProtocolICMPTCPUDP;
...
import com.ibm.cloud.is.vpc.v1.model.RemoveVpnGatewayAdvertisedCidrOptions;
...
import com.ibm.cloud.is.vpc.v1.model.SecurityGroupRuleProtocolIndividual;
...
import com.ibm.cloud.is.vpc.v1.model.ShareProfileAllowedAccessProtocols;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileAllowedAccessProtocolsSubset;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileAllowedTransitEncryptionModes;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileAllowedTransitEncryptionModesSubset;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileAvailabilityModes;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileAvailabilityModesEnum;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileAvailabilityModesFixed;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileBandwidth;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileBandwidthDependent;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileBandwidthDependentRange;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileBandwidthEnum;
import com.ibm.cloud.is.vpc.v1.model.ShareProfileBandwidthFixed;
...
import com.ibm.cloud.is.vpc.v1.model.ShareProfileStorageGeneration;
...
import com.ibm.cloud.is.vpc.v1.model.SnapshotInstanceProfileCollection;
import com.ibm.cloud.is.vpc.v1.model.SnapshotInstanceProfilesPager;
...
import com.ibm.cloud.is.vpc.v1.model.UpdateEndpointGatewayResourceBindingOptions;
...
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayAdvertisedCIDRCollection;
...
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayConnectionDynamicRouteModePeerVPNGatewayConnectionPeerByFQDN;
...
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayConnectionPeerPatchVPNGatewayConnectionDynamicRouteModePeerPatch;
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayConnectionPeerPatchVPNGatewayConnectionDynamicRouteModePeerPatchVPNGatewayConnectionDynamicRouteModePeerPatchVPNGatewayConnectionPeerAddressPatch;
...
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayServiceConnection;
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayServiceConnectionCollection;
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayServiceConnectionCreator;
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayServiceConnectionCreatorTransitGatewayReference;
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayServiceConnectionLifecycleReason;
import com.ibm.cloud.is.vpc.v1.model.VPNGatewayServiceConnectionStatusReason;
...
import com.ibm.cloud.is.vpc.v1.model.VpnGatewayServiceConnectionsPager;
...
public class VpcIT extends SdkIntegrationTestBase {
  ...
  public void testListBareMetalServerCapacities() throws Exception {
    try {
      ListBareMetalServerCapacitiesOptions listBareMetalServerCapacitiesOptions = new ListBareMetalServerCapacitiesOptions.Builder()
        .start("testString")
        .limit(Long.valueOf("10"))
        .profileName("bx2d-metal-192x768")
        .zoneName("us-south-1")
        .build();

      // Invoke operation
      Response<BareMetalServerCapacityCollection> response = service.listBareMetalServerCapacities(listBareMetalServerCapacitiesOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      BareMetalServerCapacityCollection bareMetalServerCapacityCollectionResult = response.getResult();
      assertNotNull(bareMetalServerCapacityCollectionResult);
  ...
  @Test(dependsOnMethods = { "testListBareMetalServerCapacities" })
  public void testListBareMetalServerCapacitiesWithPager() throws Exception {
    try {
      ListBareMetalServerCapacitiesOptions options = new ListBareMetalServerCapacitiesOptions.Builder()
        .limit(Long.valueOf("10"))
        .profileName("bx2d-metal-192x768")
        .zoneName("us-south-1")
        .build();
      ...
      // Test getNext().
      List<BareMetalServerCapacity> allResults = new ArrayList<>();
      BareMetalServerCapacitiesPager pager = new BareMetalServerCapacitiesPager(service, options);
      while (pager.hasNext()) {
        List<BareMetalServerCapacity> nextPage = pager.getNext();
        assertNotNull(nextPage);
        allResults.addAll(nextPage);
      }
      assertFalse(allResults.isEmpty());
      ...
      // Test getAll();
      pager = new BareMetalServerCapacitiesPager(service, options);
      List<BareMetalServerCapacity> allItems = pager.getAll();
      assertNotNull(allItems);
      assertFalse(allItems.isEmpty());
  ...
  public void testListEndpointGatewayResourceBindings() throws Exception {
    try {
      ListEndpointGatewayResourceBindingsOptions listEndpointGatewayResourceBindingsOptions = new ListEndpointGatewayResourceBindingsOptions.Builder()
        .endpointGatewayId("testString")
        .start("testString")
        .limit(Long.valueOf("10"))
        .build();
      ...
      // Invoke operation
      Response<EndpointGatewayResourceBindingCollection> response = service.listEndpointGatewayResourceBindings(listEndpointGatewayResourceBindingsOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      EndpointGatewayResourceBindingCollection endpointGatewayResourceBindingCollectionResult = response.getResult();
      assertNotNull(endpointGatewayResourceBindingCollectionResult);
  ...
  @Test(dependsOnMethods = { "testListEndpointGatewayResourceBindings" })
  public void testListEndpointGatewayResourceBindingsWithPager() throws Exception {
    try {
      ListEndpointGatewayResourceBindingsOptions options = new ListEndpointGatewayResourceBindingsOptions.Builder()
        .endpointGatewayId("testString")
        .limit(Long.valueOf("10"))
        .build();
      ...
      EndpointGatewayResourceBindingsPager pager = new EndpointGatewayResourceBindingsPager(service, options);
      while (pager.hasNext()) {
      ...
      // Test getAll();
      pager = new EndpointGatewayResourceBindingsPager(service, options);
      List<EndpointGatewayResourceBinding> allItems = pager.getAll();
      assertNotNull(allItems);
      assertFalse(allItems.isEmpty());
  ...
  @Test(dependsOnMethods = { "testListEndpointGatewayResourceBindings" })
  public void testCreateEndpointGatewayResourceBinding() throws Exception {
    try {
      ...
      CreateEndpointGatewayResourceBindingOptions createEndpointGatewayResourceBindingOptions = new CreateEndpointGatewayResourceBindingOptions.Builder()
        .endpointGatewayId("testString")
      ...
      // Invoke operation
      Response<EndpointGatewayResourceBinding> response = service.createEndpointGatewayResourceBinding(createEndpointGatewayResourceBindingOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 201);

      EndpointGatewayResourceBinding endpointGatewayResourceBindingResult = response.getResult();
      assertNotNull(endpointGatewayResourceBindingResult);
  ...
  @Test(dependsOnMethods = { "testCreateEndpointGatewayResourceBinding" })
  public void testGetEndpointGatewayResourceBinding() throws Exception {
    try {
      GetEndpointGatewayResourceBindingOptions getEndpointGatewayResourceBindingOptions = new GetEndpointGatewayResourceBindingOptions.Builder()
        .endpointGatewayId("testString")
        .id("testString")
        .build();

      // Invoke operation
      Response<EndpointGatewayResourceBinding> response = service.getEndpointGatewayResourceBinding(getEndpointGatewayResourceBindingOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);
  ...
  @Test(dependsOnMethods = { "testGetEndpointGatewayResourceBinding" })
  public void testUpdateEndpointGatewayResourceBinding() throws Exception {
    try {
      EndpointGatewayResourceBindingPatch endpointGatewayResourceBindingPatchModel = new EndpointGatewayResourceBindingPatch.Builder()
        .name("my-resource-binding-updated")
        .build();
      Map<String, Object> endpointGatewayResourceBindingPatchModelAsPatch = endpointGatewayResourceBindingPatchModel.asPatch();

      UpdateEndpointGatewayResourceBindingOptions updateEndpointGatewayResourceBindingOptions = new UpdateEndpointGatewayResourceBindingOptions.Builder()
        .endpointGatewayId("testString")
        .id("testString")
      ...
      // Invoke operation
      Response<EndpointGatewayResourceBinding> response = service.updateEndpointGatewayResourceBinding(updateEndpointGatewayResourceBindingOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);
  ...
  @Test(dependsOnMethods = { "testUpdateEndpointGatewayResourceBinding" })
  ...
  public void testListImageBareMetalServerProfiles() throws Exception {
    try {
      ListImageBareMetalServerProfilesOptions listImageBareMetalServerProfilesOptions = new ListImageBareMetalServerProfilesOptions.Builder()
        .id("testString")
        .start("testString")
        .limit(Long.valueOf("10"))
        .build();
      ...
      // Invoke operation
      Response<ImageBareMetalServerProfileCollection> response = service.listImageBareMetalServerProfiles(listImageBareMetalServerProfilesOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      ImageBareMetalServerProfileCollection imageBareMetalServerProfileCollectionResult = response.getResult();
      assertNotNull(imageBareMetalServerProfileCollectionResult);
  ...
  @Test(dependsOnMethods = { "testListImageBareMetalServerProfiles" })
  public void testListImageBareMetalServerProfilesWithPager() throws Exception {
    try {
      ListImageBareMetalServerProfilesOptions options = new ListImageBareMetalServerProfilesOptions.Builder()
        .id("testString")
        .limit(Long.valueOf("10"))
        .build();

      // Test getNext().
      List<BareMetalServerProfileReference> allResults = new ArrayList<>();
      ImageBareMetalServerProfilesPager pager = new ImageBareMetalServerProfilesPager(service, options);
      while (pager.hasNext()) {
        List<BareMetalServerProfileReference> nextPage = pager.getNext();
        assertNotNull(nextPage);
        allResults.addAll(nextPage);
      }
      assertFalse(allResults.isEmpty());
      ...
      // Test getAll();
      pager = new ImageBareMetalServerProfilesPager(service, options);
      List<BareMetalServerProfileReference> allItems = pager.getAll();
      assertNotNull(allItems);
      assertFalse(allItems.isEmpty());
  ...
  public void testListImageInstanceProfiles() throws Exception {
    try {
      ListImageInstanceProfilesOptions listImageInstanceProfilesOptions = new ListImageInstanceProfilesOptions.Builder()
        .id("testString")
        .start("testString")
        .limit(Long.valueOf("10"))
        .build();
      ...
      // Invoke operation
      Response<ImageInstanceProfileCollection> response = service.listImageInstanceProfiles(listImageInstanceProfilesOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      ImageInstanceProfileCollection imageInstanceProfileCollectionResult = response.getResult();
      assertNotNull(imageInstanceProfileCollectionResult);
  ...
  @Test(dependsOnMethods = { "testListImageInstanceProfiles" })
  public void testListImageInstanceProfilesWithPager() throws Exception {
    try {
      ListImageInstanceProfilesOptions options = new ListImageInstanceProfilesOptions.Builder()
        .id("testString")
        .limit(Long.valueOf("10"))
        .build();

      // Test getNext().
      List<InstanceProfileReference> allResults = new ArrayList<>();
      ImageInstanceProfilesPager pager = new ImageInstanceProfilesPager(service, options);
      while (pager.hasNext()) {
        List<InstanceProfileReference> nextPage = pager.getNext();
        assertNotNull(nextPage);
        allResults.addAll(nextPage);
      }
      assertFalse(allResults.isEmpty());
      ...
      // Test getAll();
      pager = new ImageInstanceProfilesPager(service, options);
      List<InstanceProfileReference> allItems = pager.getAll();
      assertNotNull(allItems);
      assertFalse(allItems.isEmpty());
  ...
  public void testListInstanceProfiles() throws Exception {
    try {
      ListInstanceProfilesOptions listInstanceProfilesOptions = new ListInstanceProfilesOptions.Builder()
        .start("testString")
        .limit(Long.valueOf("10"))
        .build();
  ...
  public void testListInstanceProfilesWithPager() throws Exception {
    try {
      ListInstanceProfilesOptions options = new ListInstanceProfilesOptions.Builder()
        .limit(Long.valueOf("10"))
        .build();

      // Test getNext().
      List<InstanceProfile> allResults = new ArrayList<>();
      InstanceProfilesPager pager = new InstanceProfilesPager(service, options);
      while (pager.hasNext()) {
        List<InstanceProfile> nextPage = pager.getNext();
        assertNotNull(nextPage);
        allResults.addAll(nextPage);
      }
      assertFalse(allResults.isEmpty());
      ...
      // Test getAll();
      pager = new InstanceProfilesPager(service, options);
      List<InstanceProfile> allItems = pager.getAll();
      assertNotNull(allItems);
      assertFalse(allItems.isEmpty());
  ...
  public void testCreateInstanceReinitialization() throws Exception {
    try {
      TrustedProfileIdentityById trustedProfileIdentityModel = new TrustedProfileIdentityById.Builder()
        .id("Profile-9fd84246-7df4-4667-94e4-8ecde51d5ac5")
        .build();
      ...
      CreateInstanceReinitializationOptions createInstanceReinitializationOptions = new CreateInstanceReinitializationOptions.Builder()
        .id("testString")
        .instanceReinitializePrototype(instanceReinitializePrototypeModel)
        .build();

      // Invoke operation
      Response<Void> response = service.createInstanceReinitialization(createInstanceReinitializationOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 204);
    } catch (ServiceResponseException e) {
  ...
  @Test(dependsOnMethods = { "testCreateInstanceReinitialization" })
  ...
  public void testListInstanceSoftwareAttachments() throws Exception {
    try {
      ...
      // Invoke operation
      Response<InstanceSoftwareAttachmentCollection> response = service.listInstanceSoftwareAttachments(listInstanceSoftwareAttachmentsOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      InstanceSoftwareAttachmentCollection instanceSoftwareAttachmentCollectionResult = response.getResult();
      assertNotNull(instanceSoftwareAttachmentCollectionResult);
  ...
  @Test(dependsOnMethods = { "testListInstanceSoftwareAttachments" })
  public void testGetInstanceSoftwareAttachment() throws Exception {
    try {
      ...
      // Invoke operation
      Response<InstanceSoftwareAttachment> response = service.getInstanceSoftwareAttachment(getInstanceSoftwareAttachmentOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      InstanceSoftwareAttachment instanceSoftwareAttachmentResult = response.getResult();
      assertNotNull(instanceSoftwareAttachmentResult);
  ...
  @Test(dependsOnMethods = { "testGetInstanceSoftwareAttachment" })
  public void testUpdateInstanceSoftwareAttachment() throws Exception {
    try {
      InstanceSoftwareAttachmentPatch instanceSoftwareAttachmentPatchModel = new InstanceSoftwareAttachmentPatch.Builder()
        ...
        .build();
      Map<String, Object> instanceSoftwareAttachmentPatchModelAsPatch = instanceSoftwareAttachmentPatchModel.asPatch();

      UpdateInstanceSoftwareAttachmentOptions updateInstanceSoftwareAttachmentOptions = new UpdateInstanceSoftwareAttachmentOptions.Builder()
        .instanceId("testString")
        .id("testString")
      ...
      // Invoke operation
      Response<InstanceSoftwareAttachment> response = service.updateInstanceSoftwareAttachment(updateInstanceSoftwareAttachmentOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);
  ...
  @Test(dependsOnMethods = { "testUpdateInstanceSoftwareAttachment" })
  ...
  public void testCreateLoadBalancer() throws Exception {
    try {
      ...
      LoadBalancerListenerClientAuthenticationPrototype loadBalancerListenerClientAuthenticationPrototypeModel = new LoadBalancerListenerClientAuthenticationPrototype.Builder()
      ...
      LoadBalancerListenerPrototypeLoadBalancerContext loadBalancerListenerPrototypeLoadBalancerContextModel = new LoadBalancerListenerPrototypeLoadBalancerContext.Builder()
        ...
        .clientAuthentication(loadBalancerListenerClientAuthenticationPrototypeModel)
  ...
  public void testListSnapshotInstanceProfiles() throws Exception {
    try {
      ListSnapshotInstanceProfilesOptions listSnapshotInstanceProfilesOptions = new ListSnapshotInstanceProfilesOptions.Builder()
        .id("testString")
        .start("testString")
        .limit(Long.valueOf("10"))
        .build();
      ...
      // Invoke operation
      Response<SnapshotInstanceProfileCollection> response = service.listSnapshotInstanceProfiles(listSnapshotInstanceProfilesOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      SnapshotInstanceProfileCollection snapshotInstanceProfileCollectionResult = response.getResult();
      assertNotNull(snapshotInstanceProfileCollectionResult);
  ...
  @Test(dependsOnMethods = { "testListSnapshotInstanceProfiles" })
  public void testListSnapshotInstanceProfilesWithPager() throws Exception {
    try {
      ListSnapshotInstanceProfilesOptions options = new ListSnapshotInstanceProfilesOptions.Builder()
        .id("testString")
        .limit(Long.valueOf("10"))
        .build();
      ...
      // Test getNext().
      List<InstanceProfileReference> allResults = new ArrayList<>();
      SnapshotInstanceProfilesPager pager = new SnapshotInstanceProfilesPager(service, options);
      while (pager.hasNext()) {
        List<InstanceProfileReference> nextPage = pager.getNext();
        assertNotNull(nextPage);
        allResults.addAll(nextPage);
      ...
      // Test getAll();
      pager = new SnapshotInstanceProfilesPager(service, options);
      List<InstanceProfileReference> allItems = pager.getAll();
      assertNotNull(allItems);
      assertFalse(allItems.isEmpty());
  ...
  public void testListVolumeInstanceProfiles() throws Exception {
    try {
      ListVolumeInstanceProfilesOptions listVolumeInstanceProfilesOptions = new ListVolumeInstanceProfilesOptions.Builder()
        .id("testString")
        .start("testString")
        .limit(Long.valueOf("10"))
        .build();
      ...
      // Invoke operation
      Response<VolumeInstanceProfileCollection> response = service.listVolumeInstanceProfiles(listVolumeInstanceProfilesOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      VolumeInstanceProfileCollection volumeInstanceProfileCollectionResult = response.getResult();
      assertNotNull(volumeInstanceProfileCollectionResult);
  ...
  public void testListVolumeInstanceProfilesWithPager() throws Exception {
    try {
      ListVolumeInstanceProfilesOptions options = new ListVolumeInstanceProfilesOptions.Builder()
        .id("testString")
        .limit(Long.valueOf("10"))
        .build();
      ...
      // Test getNext().
      List<InstanceProfileReference> allResults = new ArrayList<>();
      VolumeInstanceProfilesPager pager = new VolumeInstanceProfilesPager(service, options);
      while (pager.hasNext()) {
        List<InstanceProfileReference> nextPage = pager.getNext();
        assertNotNull(nextPage);
        allResults.addAll(nextPage);
      ...
      // Test getAll();
      pager = new VolumeInstanceProfilesPager(service, options);
      List<InstanceProfileReference> allItems = pager.getAll();
      assertNotNull(allItems);
      assertFalse(allItems.isEmpty());
  ...
  public void testListVpnGatewayAdvertisedCidrs() throws Exception {
    try {
      ...
      // Invoke operation
      Response<VPNGatewayAdvertisedCIDRCollection> response = service.listVpnGatewayAdvertisedCidrs(listVpnGatewayAdvertisedCidrsOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      VPNGatewayAdvertisedCIDRCollection vpnGatewayAdvertisedCidrCollectionResult = response.getResult();
      assertNotNull(vpnGatewayAdvertisedCidrCollectionResult);
  ...
  @Test(dependsOnMethods = { "testListVpnGatewayAdvertisedCidrs" })
  public void testCheckVpnGatewayAdvertisedCidr() throws Exception {
    try {
  ...
  @Test(dependsOnMethods = { "testCheckVpnGatewayAdvertisedCidr" })
  public void testAddVpnGatewayAdvertisedCidr() throws Exception {
    try {
  ...
  @Test(dependsOnMethods = { "testAddVpnGatewayAdvertisedCidr" })
  ...
  public void testListVpnGatewayServiceConnections() throws Exception {
    try {
      ...
      // Invoke operation
      Response<VPNGatewayServiceConnectionCollection> response = service.listVpnGatewayServiceConnections(listVpnGatewayServiceConnectionsOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      VPNGatewayServiceConnectionCollection vpnGatewayServiceConnectionCollectionResult = response.getResult();
      assertNotNull(vpnGatewayServiceConnectionCollectionResult);
  ...
  @Test(dependsOnMethods = { "testListVpnGatewayServiceConnections" })
  public void testListVpnGatewayServiceConnectionsWithPager() throws Exception {
    try {
      ListVpnGatewayServiceConnectionsOptions options = new ListVpnGatewayServiceConnectionsOptions.Builder()
        .vpnGatewayId("testString")
        .limit(Long.valueOf("10"))
        .build();

      // Test getNext().
      List<VPNGatewayServiceConnection> allResults = new ArrayList<>();
      VpnGatewayServiceConnectionsPager pager = new VpnGatewayServiceConnectionsPager(service, options);
      while (pager.hasNext()) {
        List<VPNGatewayServiceConnection> nextPage = pager.getNext();
        assertNotNull(nextPage);
        allResults.addAll(nextPage);
      }
      assertFalse(allResults.isEmpty());
      ...
      // Test getAll();
      pager = new VpnGatewayServiceConnectionsPager(service, options);
      List<VPNGatewayServiceConnection> allItems = pager.getAll();
      assertNotNull(allItems);
      assertFalse(allItems.isEmpty());
  ...
  @Test(dependsOnMethods = { "testListVpnGatewayServiceConnections" })
  public void testGetVpnGatewayServiceConnection() throws Exception {
    try {
      ...
      // Invoke operation
      Response<VPNGatewayServiceConnection> response = service.getVpnGatewayServiceConnection(getVpnGatewayServiceConnectionOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 200);

      VPNGatewayServiceConnection vpnGatewayServiceConnectionResult = response.getResult();
      assertNotNull(vpnGatewayServiceConnectionResult);
  ...
  @Test(dependsOnMethods = { "testGetVpnGatewayServiceConnection" })
  ...
  public void testDeleteEndpointGatewayResourceBinding() throws Exception {
    try {
      DeleteEndpointGatewayResourceBindingOptions deleteEndpointGatewayResourceBindingOptions = new DeleteEndpointGatewayResourceBindingOptions.Builder()
        .endpointGatewayId("testString")
        .id("testString")
        .build();

      // Invoke operation
      Response<Void> response = service.deleteEndpointGatewayResourceBinding(deleteEndpointGatewayResourceBindingOptions).execute();
      // Validate response
      assertNotNull(response);
      assertEquals(response.getStatusCode(), 204);
    } catch (ServiceResponseException e) {
  ...
  @Test(dependsOnMethods = { "testDeleteEndpointGatewayResourceBinding" })
  ...
  @Test(dependsOnMethods = { "testDeletePrivatePathServiceGatewayAccountPolicy" })
  ...
  public void testRemoveVpnGatewayAdvertisedCidr() throws Exception {
    try {
  ...
  @Test(dependsOnMethods = { "testRemoveVpnGatewayAdvertisedCidr" })
