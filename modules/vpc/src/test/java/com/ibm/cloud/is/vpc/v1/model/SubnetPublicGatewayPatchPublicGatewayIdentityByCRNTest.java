...
public class SubnetPublicGatewayPatchPublicGatewayIdentityByCRNTest {
  ...
  public void testSubnetPublicGatewayPatchPublicGatewayIdentityByCRN() throws Throwable {
    SubnetPublicGatewayPatchPublicGatewayIdentityByCRN subnetPublicGatewayPatchPublicGatewayIdentityByCrnModel = new SubnetPublicGatewayPatchPublicGatewayIdentityByCRN.Builder()
      ...
      .build();
    assertEquals(subnetPublicGatewayPatchPublicGatewayIdentityByCrnModel.crn(), "crn:v1:bluemix:public:is:us-south-1:a/aa2432b1fa4d4ace891e9b80fc104e34::public-gateway:r006-dc5431ef-1fc6-4861-adc9-a59d077d1241");
    ...
    assertEquals(subnetPublicGatewayPatchPublicGatewayIdentityByCrnModelNew.crn(), "crn:v1:bluemix:public:is:us-south-1:a/aa2432b1fa4d4ace891e9b80fc104e34::public-gateway:r006-dc5431ef-1fc6-4861-adc9-a59d077d1241");
  }
