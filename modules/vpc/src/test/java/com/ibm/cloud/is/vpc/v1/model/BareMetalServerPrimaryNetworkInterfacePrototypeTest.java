...
public class BareMetalServerPrimaryNetworkInterfacePrototypeTest {
  ...
  public void testBareMetalServerPrimaryNetworkInterfacePrototype() throws Throwable {
    ...
    assertEquals(bareMetalServerPrimaryNetworkInterfacePrototypeModel.primaryIpv4Address(), "10.0.0.5");
    ...
    assertEquals(bareMetalServerPrimaryNetworkInterfacePrototypeModelNew.primaryIpv4Address(), "10.0.0.5");
