...
/**
 * Unit test class for the VPNGatewayConnectionPolicyModeLocalPrototype model.
 */
public class VPNGatewayConnectionPolicyModeLocalPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVPNGatewayConnectionPolicyModeLocalPrototype() throws Throwable {
    ...
    VPNGatewayConnectionPolicyModeLocalPrototype vpnGatewayConnectionPolicyModeLocalPrototypeModelNew = TestUtilities.deserialize(json, VPNGatewayConnectionPolicyModeLocalPrototype.class);
    assertTrue(vpnGatewayConnectionPolicyModeLocalPrototypeModelNew instanceof VPNGatewayConnectionPolicyModeLocalPrototype);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testVPNGatewayConnectionPolicyModeLocalPrototypeError() throws Throwable {
    new VPNGatewayConnectionPolicyModeLocalPrototype.Builder().build();
  }
