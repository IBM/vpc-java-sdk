...
/**
 * Unit test class for the VPCDNSResolutionBindingCollection model.
 */
public class VPCDNSResolutionBindingCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testVPCDNSResolutionBindingCollection() throws Throwable {
    VPCDNSResolutionBindingCollection vpcdnsResolutionBindingCollectionModel = new VPCDNSResolutionBindingCollection();
    assertNull(vpcdnsResolutionBindingCollectionModel.getDnsResolutionBindings());
    assertNull(vpcdnsResolutionBindingCollectionModel.getFirst());
    assertNull(vpcdnsResolutionBindingCollectionModel.getLimit());
    assertNull(vpcdnsResolutionBindingCollectionModel.getNext());
    assertNull(vpcdnsResolutionBindingCollectionModel.getTotalCount());
  }
}