...
/**
 * Unit test class for the LoadBalancerPoolFailsafePolicyPrototype model.
 */
public class LoadBalancerPoolFailsafePolicyPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testLoadBalancerPoolFailsafePolicyPrototype() throws Throwable {
    ...
    String json = TestUtilities.serialize(loadBalancerPoolFailsafePolicyPrototypeModel);

    LoadBalancerPoolFailsafePolicyPrototype loadBalancerPoolFailsafePolicyPrototypeModelNew = TestUtilities.deserialize(json, LoadBalancerPoolFailsafePolicyPrototype.class);
    assertTrue(loadBalancerPoolFailsafePolicyPrototypeModelNew instanceof LoadBalancerPoolFailsafePolicyPrototype);
    assertEquals(loadBalancerPoolFailsafePolicyPrototypeModelNew.action(), "forward");
    assertEquals(loadBalancerPoolFailsafePolicyPrototypeModelNew.target().toString(), loadBalancerPoolIdentityModel.toString());
  }
}