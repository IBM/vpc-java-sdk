...
/**
 * Unit test class for the InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachment model.
 */
public class InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachment() throws Throwable {
    ...
    InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachment instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel = new InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachment.Builder()
      ...
      .build();
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.availability(), instanceAvailabilityPrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.availabilityPolicy(), instanceAvailabilityPolicyPrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.clusterNetworkAttachments(), java.util.Arrays.asList(instanceClusterNetworkAttachmentPrototypeInstanceContextModel));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.confidentialComputeMode(), "disabled");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.defaultTrustedProfile(), instanceDefaultTrustedProfilePrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.enableSecureBoot(), Boolean.valueOf(true));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.keys(), java.util.Arrays.asList(keyIdentityModel));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.metadataService(), instanceMetadataServicePrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.name(), "my-instance");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.placementTarget(), instancePlacementTargetPrototypeModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.profile(), instanceProfileIdentityModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.reservationAffinity(), instanceReservationAffinityPrototypeModel);
    ...
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.threadsPerCore(), Long.valueOf("1"));
    ...
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.userData(), "[...]");
    ...
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.zone(), zoneIdentityModel);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.networkAttachments(), java.util.Arrays.asList(instanceNetworkAttachmentPrototypeModel));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel.primaryNetworkAttachment(), instanceNetworkAttachmentPrototypeModel);

    String json = TestUtilities.serialize(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModel);

    InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachment instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew = TestUtilities.deserialize(json, InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachment.class);
    assertTrue(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew instanceof InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachment);
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.availability().toString(), instanceAvailabilityPrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.availabilityPolicy().toString(), instanceAvailabilityPolicyPrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.confidentialComputeMode(), "disabled");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.defaultTrustedProfile().toString(), instanceDefaultTrustedProfilePrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.enableSecureBoot(), Boolean.valueOf(true));
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.metadataService().toString(), instanceMetadataServicePrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.name(), "my-instance");
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.placementTarget().toString(), instancePlacementTargetPrototypeModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.profile().toString(), instanceProfileIdentityModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.reservationAffinity().toString(), instanceReservationAffinityPrototypeModel.toString());
    ...
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.threadsPerCore(), Long.valueOf("1"));
    ...
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.userData(), "[...]");
    ...
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.zone().toString(), zoneIdentityModel.toString());
    assertEquals(instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentModelNew.primaryNetworkAttachment().toString(), instanceNetworkAttachmentPrototypeModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testInstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachmentError() throws Throwable {
    new InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkAttachment.Builder().build();
  }
