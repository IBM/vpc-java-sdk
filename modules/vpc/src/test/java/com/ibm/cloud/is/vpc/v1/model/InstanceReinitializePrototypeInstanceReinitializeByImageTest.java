...
/**
 * Unit test class for the InstanceReinitializePrototypeInstanceReinitializeByImage model.
 */
public class InstanceReinitializePrototypeInstanceReinitializeByImageTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInstanceReinitializePrototypeInstanceReinitializeByImage() throws Throwable {
    ...
    InstanceReinitializePrototypeInstanceReinitializeByImage instanceReinitializePrototypeInstanceReinitializeByImageModel = new InstanceReinitializePrototypeInstanceReinitializeByImage.Builder()
      ...
      .build();
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModel.defaultTrustedProfile(), instanceDefaultTrustedProfilePrototypeModel);
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModel.keys(), java.util.Arrays.asList(keyIdentityModel));
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModel.userData(), "[...]");
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModel.bootVolumeAttachment(), volumeAttachmentPrototypeInstanceByImageContextModel);
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModel.image(), imageIdentityModel);

    String json = TestUtilities.serialize(instanceReinitializePrototypeInstanceReinitializeByImageModel);

    InstanceReinitializePrototypeInstanceReinitializeByImage instanceReinitializePrototypeInstanceReinitializeByImageModelNew = TestUtilities.deserialize(json, InstanceReinitializePrototypeInstanceReinitializeByImage.class);
    assertTrue(instanceReinitializePrototypeInstanceReinitializeByImageModelNew instanceof InstanceReinitializePrototypeInstanceReinitializeByImage);
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModelNew.defaultTrustedProfile().toString(), instanceDefaultTrustedProfilePrototypeModel.toString());
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModelNew.userData(), "[...]");
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModelNew.bootVolumeAttachment().toString(), volumeAttachmentPrototypeInstanceByImageContextModel.toString());
    assertEquals(instanceReinitializePrototypeInstanceReinitializeByImageModelNew.image().toString(), imageIdentityModel.toString());
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testInstanceReinitializePrototypeInstanceReinitializeByImageError() throws Throwable {
    new InstanceReinitializePrototypeInstanceReinitializeByImage.Builder().build();
  }
