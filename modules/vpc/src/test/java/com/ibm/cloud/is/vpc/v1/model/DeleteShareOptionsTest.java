...
/**
 * Unit test class for the DeleteShareOptions model.
 */
public class DeleteShareOptionsTest {
  ...
  public void testDeleteShareOptionsError() throws Throwable {
    new DeleteShareOptions.Builder().build();
  }
