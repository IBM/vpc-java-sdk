...
public class LoadBalancerListenerPrototypeLoadBalancerContextTest {
  ...
  public void testLoadBalancerListenerPrototypeLoadBalancerContext() throws Throwable {
    ...
    assertEquals(loadBalancerListenerPrototypeLoadBalancerContextModel.clientAuthentication(), loadBalancerListenerClientAuthenticationPrototypeModel);
    ...
    assertEquals(loadBalancerListenerPrototypeLoadBalancerContextModelNew.clientAuthentication().toString(), loadBalancerListenerClientAuthenticationPrototypeModel.toString());
