...
public class LoadBalancerListenerIdentityByHrefTest {
  ...
  public void testLoadBalancerListenerIdentityByHref() throws Throwable {
    LoadBalancerListenerIdentityByHref loadBalancerListenerIdentityByHrefModel = new LoadBalancerListenerIdentityByHref.Builder()
      ...
      .build();
    assertEquals(loadBalancerListenerIdentityByHrefModel.href(), "https://us-south.iaas.cloud.ibm.com/v1/load_balancers/r006-dd754295-e9e0-4c9d-bf6c-58fbc59e5727/listeners/r006-97c05c26-4748-4db8-ac3f-d8a9c79a7091");
    ...
    assertEquals(loadBalancerListenerIdentityByHrefModelNew.href(), "https://us-south.iaas.cloud.ibm.com/v1/load_balancers/r006-dd754295-e9e0-4c9d-bf6c-58fbc59e5727/listeners/r006-97c05c26-4748-4db8-ac3f-d8a9c79a7091");
  }
