...
public class CloudObjectStorageBucketIdentityByCRNTest {
  ...
  public void testCloudObjectStorageBucketIdentityByCRN() throws Throwable {
    CloudObjectStorageBucketIdentityByCRN cloudObjectStorageBucketIdentityByCrnModel = new CloudObjectStorageBucketIdentityByCRN.Builder()
      ...
      .build();
    assertEquals(cloudObjectStorageBucketIdentityByCrnModel.crn(), "crn:v1:bluemix:public:cloud-object-storage:global:a/aa2432b1fa4d4ace891e9b80fc104e34:1a0ec336-f391-4091-a6fb-5e084a4c56f4:bucket:bucket-27200-lwx4cfvcue");
    ...
    assertEquals(cloudObjectStorageBucketIdentityByCrnModelNew.crn(), "crn:v1:bluemix:public:cloud-object-storage:global:a/aa2432b1fa4d4ace891e9b80fc104e34:1a0ec336-f391-4091-a6fb-5e084a4c56f4:bucket:bucket-27200-lwx4cfvcue");
  }
