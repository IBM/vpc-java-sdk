...
public class CloudObjectStorageBucketIdentityByCRNTest {
  ...
  public void testCloudObjectStorageBucketIdentityByCRN() throws Throwable {
    CloudObjectStorageBucketIdentityByCRN cloudObjectStorageBucketIdentityByCrnModel = new CloudObjectStorageBucketIdentityByCRN.Builder()
      .crn("crn:v1:bluemix:public:cloud-object-storage:global:a/59bcbfa6ea2f006b4ed7094c1a08dcdd:1a0ec336-f391-4091-a6fb-5e084a4c56f4:bucket:my-bucket")
      .build();
    assertEquals(cloudObjectStorageBucketIdentityByCrnModel.crn(), "crn:v1:bluemix:public:cloud-object-storage:global:a/59bcbfa6ea2f006b4ed7094c1a08dcdd:1a0ec336-f391-4091-a6fb-5e084a4c56f4:bucket:my-bucket");
    ...
    assertEquals(cloudObjectStorageBucketIdentityByCrnModelNew.crn(), "crn:v1:bluemix:public:cloud-object-storage:global:a/59bcbfa6ea2f006b4ed7094c1a08dcdd:1a0ec336-f391-4091-a6fb-5e084a4c56f4:bucket:my-bucket");
  }
