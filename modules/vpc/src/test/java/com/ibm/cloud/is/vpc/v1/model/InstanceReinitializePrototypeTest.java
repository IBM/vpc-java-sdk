...
/**
 * Unit test class for the InstanceReinitializePrototype model.
 */
public class InstanceReinitializePrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  // TODO: Add tests for models that are abstract
  @Test
  public void testInstanceReinitializePrototype() throws Throwable {
    InstanceReinitializePrototype instanceReinitializePrototypeModel = new InstanceReinitializePrototype();
    assertNotNull(instanceReinitializePrototypeModel);
  }
}