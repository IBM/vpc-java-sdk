...
/**
 * Unit test class for the ShareMountTarget model.
 */
public class ShareMountTargetTest {
  ...
  public void testShareMountTarget() throws Throwable {
    ...
    assertNull(shareMountTargetModel.getLifecycleState());
    assertNull(shareMountTargetModel.getMountPath());
    assertNull(shareMountTargetModel.getName());
    assertNull(shareMountTargetModel.getPrimaryIp());
    assertNull(shareMountTargetModel.getResourceType());
    assertNull(shareMountTargetModel.getSubnet());
    assertNull(shareMountTargetModel.getTransitEncryption());
    assertNull(shareMountTargetModel.getVirtualNetworkInterface());
    assertNull(shareMountTargetModel.getVpc());
  }
}