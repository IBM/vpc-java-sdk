 ...
 */
public class VolumeAllowedUsePrototype extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing VolumeAllowedUsePrototype instance.
     *
     * @param volumeAllowedUsePrototype the instance to initialize the Builder with
     */
    private Builder(VolumeAllowedUsePrototype volumeAllowedUsePrototype) {
      this.apiVersion = volumeAllowedUsePrototype.apiVersion;
      this.bareMetalServer = volumeAllowedUsePrototype.bareMetalServer;
      this.instance = volumeAllowedUsePrototype.instance;
    }
    ...
    /**
     * Builds a VolumeAllowedUsePrototype.
     *
     * @return the new VolumeAllowedUsePrototype instance
     */
    public VolumeAllowedUsePrototype build() {
      return new VolumeAllowedUsePrototype(this);
    }
     ...
     * @return the VolumeAllowedUsePrototype builder
     */
  ...
  protected VolumeAllowedUsePrototype(Builder builder) {
   ...
   * New builder.
   *
   * @return a VolumeAllowedUsePrototype builder
   */
