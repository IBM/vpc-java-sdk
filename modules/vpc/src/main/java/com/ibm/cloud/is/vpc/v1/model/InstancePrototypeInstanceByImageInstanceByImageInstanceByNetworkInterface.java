...
public class InstancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface extends InstancePrototypeInstanceByImage {
  ...
  public static class Builder {
    ...
    public Builder(InstancePrototypeInstanceByImage instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface) {
      ...
      this.enableSecureBoot = instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface.enableSecureBoot;
      ...
      this.threadsPerCore = instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface.threadsPerCore;
      ...
      this.vcpu = instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface.vcpu;
      this.volumeAttachments = instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface.volumeAttachments;
      this.volumeBandwidthQosMode = instancePrototypeInstanceByImageInstanceByImageInstanceByNetworkInterface.volumeBandwidthQosMode;
