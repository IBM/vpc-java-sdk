 ...
 */
public class LoadBalancerPoolServerAuthenticationPatch extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing LoadBalancerPoolServerAuthenticationPatch instance.
     *
     * @param loadBalancerPoolServerAuthenticationPatch the instance to initialize the Builder with
     */
    private Builder(LoadBalancerPoolServerAuthenticationPatch loadBalancerPoolServerAuthenticationPatch) {
      this.certificateAuthority = loadBalancerPoolServerAuthenticationPatch.certificateAuthority;
      this.verifyCertificate = loadBalancerPoolServerAuthenticationPatch.verifyCertificate;
    }
    ...
    /**
     * Builds a LoadBalancerPoolServerAuthenticationPatch.
     *
     * @return the new LoadBalancerPoolServerAuthenticationPatch instance
     */
    public LoadBalancerPoolServerAuthenticationPatch build() {
      return new LoadBalancerPoolServerAuthenticationPatch(this);
    }
     ...
     * @return the LoadBalancerPoolServerAuthenticationPatch builder
     */
  ...
  protected LoadBalancerPoolServerAuthenticationPatch() { }

  protected LoadBalancerPoolServerAuthenticationPatch(Builder builder) {
   ...
   * New builder.
   *
   * @return a LoadBalancerPoolServerAuthenticationPatch builder
   */
