 ...
 */
public class ImageAllowedUsePrototype extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ImageAllowedUsePrototype instance.
     *
     * @param imageAllowedUsePrototype the instance to initialize the Builder with
     */
    private Builder(ImageAllowedUsePrototype imageAllowedUsePrototype) {
      this.apiVersion = imageAllowedUsePrototype.apiVersion;
      this.bareMetalServer = imageAllowedUsePrototype.bareMetalServer;
      this.instance = imageAllowedUsePrototype.instance;
    }
    ...
    /**
     * Builds a ImageAllowedUsePrototype.
     *
     * @return the new ImageAllowedUsePrototype instance
     */
    public ImageAllowedUsePrototype build() {
      return new ImageAllowedUsePrototype(this);
    }
     ...
     * @return the ImageAllowedUsePrototype builder
     */
  ...
  protected ImageAllowedUsePrototype(Builder builder) {
   ...
   * New builder.
   *
   * @return a ImageAllowedUsePrototype builder
   */
