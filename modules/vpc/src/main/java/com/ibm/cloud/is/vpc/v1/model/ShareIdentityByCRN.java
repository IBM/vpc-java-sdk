...
public class ShareIdentityByCRN extends ShareIdentity {
  ...
  public static class Builder {
     ...
     *
     * @param shareIdentityByCrn the instance to initialize the Builder with
     */
    public Builder(ShareIdentity shareIdentityByCrn) {
      this.crn = shareIdentityByCrn.crn;
    }
     ...
     *
     * @return the new ShareIdentityByCRN instance
     */
     ...
     *
     * @param crn the crn
     * @return the ShareIdentityByCRN builder
     */
   ...
   * New builder.
   *
   * @return a ShareIdentityByCRN builder
   */
