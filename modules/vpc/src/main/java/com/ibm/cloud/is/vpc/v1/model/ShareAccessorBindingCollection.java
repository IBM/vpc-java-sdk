 ...
 */
public class ShareAccessorBindingCollection extends GenericModel {
  ...
  protected ShareAccessorBindingCollection() { }
   ...
   */
  public List<ShareAccessorBinding> getAccessorBindings() {
