 ...
 */
public class VPNGatewayConnectionDynamicRouteModeLocalPrototype extends VPNGatewayConnectionLocalPrototype {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing VPNGatewayConnectionDynamicRouteModeLocalPrototype instance.
     *
     * @param vpnGatewayConnectionDynamicRouteModeLocalPrototype the instance to initialize the Builder with
     */
    private Builder(VPNGatewayConnectionDynamicRouteModeLocalPrototype vpnGatewayConnectionDynamicRouteModeLocalPrototype) {
      this.ikeIdentities = vpnGatewayConnectionDynamicRouteModeLocalPrototype.ikeIdentities;
    }
    ...
    /**
     * Builds a VPNGatewayConnectionDynamicRouteModeLocalPrototype.
     *
     * @return the new VPNGatewayConnectionDynamicRouteModeLocalPrototype instance
     */
    public VPNGatewayConnectionDynamicRouteModeLocalPrototype build() {
      return new VPNGatewayConnectionDynamicRouteModeLocalPrototype(this);
    }
     ...
     * @return the VPNGatewayConnectionDynamicRouteModeLocalPrototype builder
     */
  ...
  protected VPNGatewayConnectionDynamicRouteModeLocalPrototype(Builder builder) {
   ...
   * New builder.
   *
   * @return a VPNGatewayConnectionDynamicRouteModeLocalPrototype builder
   */
