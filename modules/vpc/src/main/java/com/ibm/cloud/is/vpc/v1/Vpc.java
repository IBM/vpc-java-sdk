...
public class Vpc extends BaseService {
 ...
 /**
  ...
  public ServiceCall<BareMetalServerInitialization> replaceBareMetalServerInitialization(ReplaceBareMetalServerInitializationOptions replaceBareMetalServerInitializationOptions) {
    ...
    if (replaceBareMetalServerInitializationOptions.defaultTrustedProfile() != null) {
      contentJson.add("default_trusted_profile", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(replaceBareMetalServerInitializationOptions.defaultTrustedProfile()));
    }
  ...
  public ServiceCall<EndpointGatewayCollection> listEndpointGateways(ListEndpointGatewaysOptions listEndpointGatewaysOptions) {
    ...
    if (listEndpointGatewaysOptions.dnsResolutionBindingMode() != null) {
      builder.query("dns_resolution_binding_mode", RequestUtils.join(listEndpointGatewaysOptions.dnsResolutionBindingMode(), ","));
    }
  ...
  public ServiceCall<EndpointGateway> createEndpointGateway(CreateEndpointGatewayOptions createEndpointGatewayOptions) {
    ...
    if (createEndpointGatewayOptions.dnsResolutionBindingMode() != null) {
      contentJson.addProperty("dns_resolution_binding_mode", createEndpointGatewayOptions.dnsResolutionBindingMode());
    }
   ...
   * values.
   *
   * @param listEndpointGatewayResourceBindingsOptions the {@link ListEndpointGatewayResourceBindingsOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link EndpointGatewayResourceBindingCollection}
   */
  public ServiceCall<EndpointGatewayResourceBindingCollection> listEndpointGatewayResourceBindings(ListEndpointGatewayResourceBindingsOptions listEndpointGatewayResourceBindingsOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(listEndpointGatewayResourceBindingsOptions,
      "listEndpointGatewayResourceBindingsOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("endpoint_gateway_id", listEndpointGatewayResourceBindingsOptions.endpointGatewayId());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/endpoint_gateways/{endpoint_gateway_id}/resource_bindings", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "listEndpointGatewayResourceBindings");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    if (listEndpointGatewayResourceBindingsOptions.start() != null) {
      builder.query("start", String.valueOf(listEndpointGatewayResourceBindingsOptions.start()));
    }
    if (listEndpointGatewayResourceBindingsOptions.limit() != null) {
      builder.query("limit", String.valueOf(listEndpointGatewayResourceBindingsOptions.limit()));
    }
    ResponseConverter<EndpointGatewayResourceBindingCollection> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<EndpointGatewayResourceBindingCollection>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   *
   * @param createEndpointGatewayResourceBindingOptions the {@link CreateEndpointGatewayResourceBindingOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link EndpointGatewayResourceBinding}
   */
  public ServiceCall<EndpointGatewayResourceBinding> createEndpointGatewayResourceBinding(CreateEndpointGatewayResourceBindingOptions createEndpointGatewayResourceBindingOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(createEndpointGatewayResourceBindingOptions,
      "createEndpointGatewayResourceBindingOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("endpoint_gateway_id", createEndpointGatewayResourceBindingOptions.endpointGatewayId());
    RequestBuilder builder = RequestBuilder.post(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/endpoint_gateways/{endpoint_gateway_id}/resource_bindings", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "createEndpointGatewayResourceBinding");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    ...
    builder.query("generation", String.valueOf(this.generation));
    final JsonObject contentJson = new JsonObject();
    contentJson.add("target", com.ibm.cloud.sdk.core.util.GsonSingleton.getGson().toJsonTree(createEndpointGatewayResourceBindingOptions.target()));
    if (createEndpointGatewayResourceBindingOptions.name() != null) {
      contentJson.addProperty("name", createEndpointGatewayResourceBindingOptions.name());
    }
    builder.bodyJson(contentJson);
    ResponseConverter<EndpointGatewayResourceBinding> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<EndpointGatewayResourceBinding>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   * reversed.
   *
   * @param deleteEndpointGatewayResourceBindingOptions the {@link DeleteEndpointGatewayResourceBindingOptions} containing the options for the call
   * @return a {@link ServiceCall} with a void result
   */
  public ServiceCall<Void> deleteEndpointGatewayResourceBinding(DeleteEndpointGatewayResourceBindingOptions deleteEndpointGatewayResourceBindingOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(deleteEndpointGatewayResourceBindingOptions,
      "deleteEndpointGatewayResourceBindingOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("endpoint_gateway_id", deleteEndpointGatewayResourceBindingOptions.endpointGatewayId());
    pathParamsMap.put("id", deleteEndpointGatewayResourceBindingOptions.id());
    RequestBuilder builder = RequestBuilder.delete(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/endpoint_gateways/{endpoint_gateway_id}/resource_bindings/{id}", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "deleteEndpointGatewayResourceBinding");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.query("version", String.valueOf(this.version));
   ...
   *
   * @param getEndpointGatewayResourceBindingOptions the {@link GetEndpointGatewayResourceBindingOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link EndpointGatewayResourceBinding}
   */
  public ServiceCall<EndpointGatewayResourceBinding> getEndpointGatewayResourceBinding(GetEndpointGatewayResourceBindingOptions getEndpointGatewayResourceBindingOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(getEndpointGatewayResourceBindingOptions,
      "getEndpointGatewayResourceBindingOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("endpoint_gateway_id", getEndpointGatewayResourceBindingOptions.endpointGatewayId());
    pathParamsMap.put("id", getEndpointGatewayResourceBindingOptions.id());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/endpoint_gateways/{endpoint_gateway_id}/resource_bindings/{id}", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "getEndpointGatewayResourceBinding");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
   ...
   *
   * @param updateEndpointGatewayResourceBindingOptions the {@link UpdateEndpointGatewayResourceBindingOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link EndpointGatewayResourceBinding}
   */
  public ServiceCall<EndpointGatewayResourceBinding> updateEndpointGatewayResourceBinding(UpdateEndpointGatewayResourceBindingOptions updateEndpointGatewayResourceBindingOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(updateEndpointGatewayResourceBindingOptions,
      "updateEndpointGatewayResourceBindingOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("endpoint_gateway_id", updateEndpointGatewayResourceBindingOptions.endpointGatewayId());
    pathParamsMap.put("id", updateEndpointGatewayResourceBindingOptions.id());
    RequestBuilder builder = RequestBuilder.patch(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/endpoint_gateways/{endpoint_gateway_id}/resource_bindings/{id}", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "updateEndpointGatewayResourceBinding");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    builder.bodyContent(com.ibm.cloud.sdk.core.util.GsonSingleton.getGsonWithSerializeNulls().toJson(updateEndpointGatewayResourceBindingOptions.endpointGatewayResourceBindingPatch()), "application/merge-patch+json");
    ResponseConverter<EndpointGatewayResourceBinding> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<EndpointGatewayResourceBinding>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   *
   * @param listImageBareMetalServerProfilesOptions the {@link ListImageBareMetalServerProfilesOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link ImageBareMetalServerProfileCollection}
   */
  public ServiceCall<ImageBareMetalServerProfileCollection> listImageBareMetalServerProfiles(ListImageBareMetalServerProfilesOptions listImageBareMetalServerProfilesOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(listImageBareMetalServerProfilesOptions,
      "listImageBareMetalServerProfilesOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("id", listImageBareMetalServerProfilesOptions.id());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/images/{id}/bare_metal_server_profiles", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "listImageBareMetalServerProfiles");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    if (listImageBareMetalServerProfilesOptions.start() != null) {
      builder.query("start", String.valueOf(listImageBareMetalServerProfilesOptions.start()));
    }
    if (listImageBareMetalServerProfilesOptions.limit() != null) {
      builder.query("limit", String.valueOf(listImageBareMetalServerProfilesOptions.limit()));
    }
    ResponseConverter<ImageBareMetalServerProfileCollection> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<ImageBareMetalServerProfileCollection>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   * `user_data_format` properties, sorted by ascending `name` property values.
   *
   * @param listImageInstanceProfilesOptions the {@link ListImageInstanceProfilesOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link ImageInstanceProfileCollection}
   */
  public ServiceCall<ImageInstanceProfileCollection> listImageInstanceProfiles(ListImageInstanceProfilesOptions listImageInstanceProfilesOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(listImageInstanceProfilesOptions,
      "listImageInstanceProfilesOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("id", listImageInstanceProfilesOptions.id());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/images/{id}/instance_profiles", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "listImageInstanceProfiles");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    if (listImageInstanceProfilesOptions.start() != null) {
      builder.query("start", String.valueOf(listImageInstanceProfilesOptions.start()));
    }
    if (listImageInstanceProfilesOptions.limit() != null) {
      builder.query("limit", String.valueOf(listImageInstanceProfilesOptions.limit()));
    }
    ResponseConverter<ImageInstanceProfileCollection> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<ImageInstanceProfileCollection>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
  ...
  public ServiceCall<InstanceCollection> listInstances(ListInstancesOptions listInstancesOptions) {
    ...
    if (listInstancesOptions.instanceGroupMembershipInstanceGroupId() != null) {
      builder.query("instance_group_membership.instance_group.id", String.valueOf(listInstancesOptions.instanceGroupMembershipInstanceGroupId()));
    }
    if (listInstancesOptions.instanceGroupMembershipInstanceGroupCrn() != null) {
      builder.query("instance_group_membership.instance_group.crn", String.valueOf(listInstancesOptions.instanceGroupMembershipInstanceGroupCrn()));
    }
   ...
   * must be bootable.
   *
   * @param listSnapshotInstanceProfilesOptions the {@link ListSnapshotInstanceProfilesOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link SnapshotInstanceProfileCollection}
   */
  public ServiceCall<SnapshotInstanceProfileCollection> listSnapshotInstanceProfiles(ListSnapshotInstanceProfilesOptions listSnapshotInstanceProfilesOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(listSnapshotInstanceProfilesOptions,
      "listSnapshotInstanceProfilesOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("id", listSnapshotInstanceProfilesOptions.id());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/snapshots/{id}/instance_profiles", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "listSnapshotInstanceProfiles");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    if (listSnapshotInstanceProfilesOptions.start() != null) {
      builder.query("start", String.valueOf(listSnapshotInstanceProfilesOptions.start()));
    }
    if (listSnapshotInstanceProfilesOptions.limit() != null) {
      builder.query("limit", String.valueOf(listSnapshotInstanceProfilesOptions.limit()));
    }
    ResponseConverter<SnapshotInstanceProfileCollection> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<SnapshotInstanceProfileCollection>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
  ...
  public ServiceCall<VirtualNetworkInterface> deleteVirtualNetworkInterfaces(DeleteVirtualNetworkInterfacesOptions deleteVirtualNetworkInterfacesOptions) {
    ...
    builder.header("Accept", "application/json");
    if (deleteVirtualNetworkInterfacesOptions.ifMatch() != null) {
      builder.header("If-Match", deleteVirtualNetworkInterfacesOptions.ifMatch());
    }
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    ResponseConverter<VirtualNetworkInterface> responseConverter =
  ...
  public ServiceCall<VirtualNetworkInterface> updateVirtualNetworkInterface(UpdateVirtualNetworkInterfaceOptions updateVirtualNetworkInterfaceOptions) {
    ...
    builder.header("Accept", "application/json");
    if (updateVirtualNetworkInterfaceOptions.ifMatch() != null) {
      builder.header("If-Match", updateVirtualNetworkInterfaceOptions.ifMatch());
    }
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
   ...
   *
   * @param listVolumeInstanceProfilesOptions the {@link ListVolumeInstanceProfilesOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link VolumeInstanceProfileCollection}
   */
  public ServiceCall<VolumeInstanceProfileCollection> listVolumeInstanceProfiles(ListVolumeInstanceProfilesOptions listVolumeInstanceProfilesOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(listVolumeInstanceProfilesOptions,
      "listVolumeInstanceProfilesOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("id", listVolumeInstanceProfilesOptions.id());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/volumes/{id}/instance_profiles", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "listVolumeInstanceProfiles");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    if (listVolumeInstanceProfilesOptions.start() != null) {
      builder.query("start", String.valueOf(listVolumeInstanceProfilesOptions.start()));
    }
    if (listVolumeInstanceProfilesOptions.limit() != null) {
      builder.query("limit", String.valueOf(listVolumeInstanceProfilesOptions.limit()));
    }
   ...
   *
   * @param listVpnGatewayAdvertisedCidrsOptions the {@link ListVpnGatewayAdvertisedCidrsOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link VPNGatewayAdvertisedCIDRCollection}
   */
  public ServiceCall<VPNGatewayAdvertisedCIDRCollection> listVpnGatewayAdvertisedCidrs(ListVpnGatewayAdvertisedCidrsOptions listVpnGatewayAdvertisedCidrsOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(listVpnGatewayAdvertisedCidrsOptions,
      "listVpnGatewayAdvertisedCidrsOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("vpn_gateway_id", listVpnGatewayAdvertisedCidrsOptions.vpnGatewayId());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/vpn_gateways/{vpn_gateway_id}/advertised_cidrs", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "listVpnGatewayAdvertisedCidrs");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    ResponseConverter<VPNGatewayAdvertisedCIDRCollection> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<VPNGatewayAdvertisedCIDRCollection>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   * This request is only supported for route mode VPN gateways.
   *
   * @param removeVpnGatewayAdvertisedCidrOptions the {@link RemoveVpnGatewayAdvertisedCidrOptions} containing the options for the call
   * @return a {@link ServiceCall} with a void result
   */
  public ServiceCall<Void> removeVpnGatewayAdvertisedCidr(RemoveVpnGatewayAdvertisedCidrOptions removeVpnGatewayAdvertisedCidrOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(removeVpnGatewayAdvertisedCidrOptions,
      "removeVpnGatewayAdvertisedCidrOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("vpn_gateway_id", removeVpnGatewayAdvertisedCidrOptions.vpnGatewayId());
    pathParamsMap.put("cidr", removeVpnGatewayAdvertisedCidrOptions.cidr());
    RequestBuilder builder = RequestBuilder.delete(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/vpn_gateways/{vpn_gateway_id}/advertised_cidrs/{cidr}", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "removeVpnGatewayAdvertisedCidr");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.query("version", String.valueOf(this.version));
   ...
   * This request is only supported for route mode VPN gateways.
   *
   * @param checkVpnGatewayAdvertisedCidrOptions the {@link CheckVpnGatewayAdvertisedCidrOptions} containing the options for the call
   * @return a {@link ServiceCall} with a void result
   */
  public ServiceCall<Void> checkVpnGatewayAdvertisedCidr(CheckVpnGatewayAdvertisedCidrOptions checkVpnGatewayAdvertisedCidrOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(checkVpnGatewayAdvertisedCidrOptions,
      "checkVpnGatewayAdvertisedCidrOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("vpn_gateway_id", checkVpnGatewayAdvertisedCidrOptions.vpnGatewayId());
    pathParamsMap.put("cidr", checkVpnGatewayAdvertisedCidrOptions.cidr());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/vpn_gateways/{vpn_gateway_id}/advertised_cidrs/{cidr}", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "checkVpnGatewayAdvertisedCidr");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.query("version", String.valueOf(this.version));
   ...
   * This request is only supported for route mode VPN gateways.
   *
   * @param addVpnGatewayAdvertisedCidrOptions the {@link AddVpnGatewayAdvertisedCidrOptions} containing the options for the call
   * @return a {@link ServiceCall} with a void result
   */
  public ServiceCall<Void> addVpnGatewayAdvertisedCidr(AddVpnGatewayAdvertisedCidrOptions addVpnGatewayAdvertisedCidrOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(addVpnGatewayAdvertisedCidrOptions,
      "addVpnGatewayAdvertisedCidrOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("vpn_gateway_id", addVpnGatewayAdvertisedCidrOptions.vpnGatewayId());
    pathParamsMap.put("cidr", addVpnGatewayAdvertisedCidrOptions.cidr());
    RequestBuilder builder = RequestBuilder.put(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/vpn_gateways/{vpn_gateway_id}/advertised_cidrs/{cidr}", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "addVpnGatewayAdvertisedCidr");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.query("version", String.valueOf(this.version));
  ...
  public ServiceCall<Void> deleteVpnGatewayConnection(DeleteVpnGatewayConnectionOptions deleteVpnGatewayConnectionOptions) {
    ...
    if (deleteVpnGatewayConnectionOptions.ifMatch() != null) {
      builder.header("If-Match", deleteVpnGatewayConnectionOptions.ifMatch());
    }
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    ResponseConverter<Void> responseConverter = ResponseConverterUtils.getVoid();
  ...
  public ServiceCall<VPNGatewayConnection> updateVpnGatewayConnection(UpdateVpnGatewayConnectionOptions updateVpnGatewayConnectionOptions) {
    ...
    builder.header("Accept", "application/json");
    if (updateVpnGatewayConnectionOptions.ifMatch() != null) {
      builder.header("If-Match", updateVpnGatewayConnectionOptions.ifMatch());
    }
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
   ...
   *
   * @param listVpnGatewayServiceConnectionsOptions the {@link ListVpnGatewayServiceConnectionsOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link VPNGatewayServiceConnectionCollection}
   */
  public ServiceCall<VPNGatewayServiceConnectionCollection> listVpnGatewayServiceConnections(ListVpnGatewayServiceConnectionsOptions listVpnGatewayServiceConnectionsOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(listVpnGatewayServiceConnectionsOptions,
      "listVpnGatewayServiceConnectionsOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("vpn_gateway_id", listVpnGatewayServiceConnectionsOptions.vpnGatewayId());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/vpn_gateways/{vpn_gateway_id}/service_connections", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "listVpnGatewayServiceConnections");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    if (listVpnGatewayServiceConnectionsOptions.start() != null) {
      builder.query("start", String.valueOf(listVpnGatewayServiceConnectionsOptions.start()));
    }
    if (listVpnGatewayServiceConnectionsOptions.limit() != null) {
      builder.query("limit", String.valueOf(listVpnGatewayServiceConnectionsOptions.limit()));
    }
    ResponseConverter<VPNGatewayServiceConnectionCollection> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<VPNGatewayServiceConnectionCollection>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
   ...
   *
   * @param getVpnGatewayServiceConnectionOptions the {@link GetVpnGatewayServiceConnectionOptions} containing the options for the call
   * @return a {@link ServiceCall} with a result of type {@link VPNGatewayServiceConnection}
   */
  public ServiceCall<VPNGatewayServiceConnection> getVpnGatewayServiceConnection(GetVpnGatewayServiceConnectionOptions getVpnGatewayServiceConnectionOptions) {
    com.ibm.cloud.sdk.core.util.Validator.notNull(getVpnGatewayServiceConnectionOptions,
      "getVpnGatewayServiceConnectionOptions cannot be null");
    Map<String, String> pathParamsMap = new HashMap<String, String>();
    pathParamsMap.put("vpn_gateway_id", getVpnGatewayServiceConnectionOptions.vpnGatewayId());
    pathParamsMap.put("id", getVpnGatewayServiceConnectionOptions.id());
    RequestBuilder builder = RequestBuilder.get(RequestBuilder.resolveRequestUrl(getServiceUrl(), "/vpn_gateways/{vpn_gateway_id}/service_connections/{id}", pathParamsMap));
    Map<String, String> sdkHeaders = SdkCommon.getSdkHeaders("vpc", "v1", "getVpnGatewayServiceConnection");
    for (Entry<String, String> header : sdkHeaders.entrySet()) {
      builder.header(header.getKey(), header.getValue());
    }
    builder.header("Accept", "application/json");
    builder.query("version", String.valueOf(this.version));
    builder.query("generation", String.valueOf(this.generation));
    ResponseConverter<VPNGatewayServiceConnection> responseConverter =
      ResponseConverterUtils.getValue(new com.google.gson.reflect.TypeToken<VPNGatewayServiceConnection>() { }.getType());
    return createServiceCall(builder.build(), responseConverter);
  }
