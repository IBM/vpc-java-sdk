 ...
 */
public class SnapshotAllowedUsePatch extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing SnapshotAllowedUsePatch instance.
     *
     * @param snapshotAllowedUsePatch the instance to initialize the Builder with
     */
    private Builder(SnapshotAllowedUsePatch snapshotAllowedUsePatch) {
      this.apiVersion = snapshotAllowedUsePatch.apiVersion;
      this.bareMetalServer = snapshotAllowedUsePatch.bareMetalServer;
      this.instance = snapshotAllowedUsePatch.instance;
    }
    ...
    /**
     * Builds a SnapshotAllowedUsePatch.
     *
     * @return the new SnapshotAllowedUsePatch instance
     */
    public SnapshotAllowedUsePatch build() {
      return new SnapshotAllowedUsePatch(this);
    }
     ...
     * @return the SnapshotAllowedUsePatch builder
     */
  ...
  protected SnapshotAllowedUsePatch() { }

  protected SnapshotAllowedUsePatch(Builder builder) {
   ...
   * New builder.
   *
   * @return a SnapshotAllowedUsePatch builder
   */
