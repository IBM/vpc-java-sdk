...
public class PrivatePathServiceGatewayCollection extends GenericModel {
  ...
  protected PrivatePathServiceGatewayCollection() { }
   ...
   *
   * @return the privatePathServiceGateways
   */
  public List<PrivatePathServiceGateway> getPrivatePathServiceGateways() {
    return privatePathServiceGateways;
  }
