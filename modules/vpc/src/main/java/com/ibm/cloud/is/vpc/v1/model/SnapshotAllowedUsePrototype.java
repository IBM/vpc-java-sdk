 ...
 */
public class SnapshotAllowedUsePrototype extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing SnapshotAllowedUsePrototype instance.
     *
     * @param snapshotAllowedUsePrototype the instance to initialize the Builder with
     */
    private Builder(SnapshotAllowedUsePrototype snapshotAllowedUsePrototype) {
      this.apiVersion = snapshotAllowedUsePrototype.apiVersion;
      this.bareMetalServer = snapshotAllowedUsePrototype.bareMetalServer;
      this.instance = snapshotAllowedUsePrototype.instance;
    }
    ...
    /**
     * Builds a SnapshotAllowedUsePrototype.
     *
     * @return the new SnapshotAllowedUsePrototype instance
     */
    public SnapshotAllowedUsePrototype build() {
      return new SnapshotAllowedUsePrototype(this);
    }
     ...
     * @return the SnapshotAllowedUsePrototype builder
     */
  ...
  protected SnapshotAllowedUsePrototype() { }

  protected SnapshotAllowedUsePrototype(Builder builder) {
   ...
   * New builder.
   *
   * @return a SnapshotAllowedUsePrototype builder
   */
