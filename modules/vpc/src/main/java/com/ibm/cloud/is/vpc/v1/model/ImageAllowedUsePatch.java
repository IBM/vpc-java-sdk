 ...
 */
public class ImageAllowedUsePatch extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing ImageAllowedUsePatch instance.
     *
     * @param imageAllowedUsePatch the instance to initialize the Builder with
     */
    private Builder(ImageAllowedUsePatch imageAllowedUsePatch) {
      this.apiVersion = imageAllowedUsePatch.apiVersion;
      this.bareMetalServer = imageAllowedUsePatch.bareMetalServer;
      this.instance = imageAllowedUsePatch.instance;
    }
    ...
    /**
     * Builds a ImageAllowedUsePatch.
     *
     * @return the new ImageAllowedUsePatch instance
     */
    public ImageAllowedUsePatch build() {
      return new ImageAllowedUsePatch(this);
    }
     ...
     * @return the ImageAllowedUsePatch builder
     */
  ...
  protected ImageAllowedUsePatch() { }

  protected ImageAllowedUsePatch(Builder builder) {
   ...
   * New builder.
   *
   * @return a ImageAllowedUsePatch builder
   */
