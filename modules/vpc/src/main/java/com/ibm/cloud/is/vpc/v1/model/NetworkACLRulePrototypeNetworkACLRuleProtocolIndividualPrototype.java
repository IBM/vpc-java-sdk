 ...
 */
public class NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype extends NetworkACLRulePrototype {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype instance.
     *
     * @param networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype the instance to initialize the Builder with
     */
    public Builder(NetworkACLRulePrototype networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype) {
      this.action = networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype.action;
      this.before = networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype.before;
      this.destination = networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype.destination;
      this.direction = networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype.direction;
      this.ipVersion = networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype.ipVersion;
      this.name = networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype.name;
      this.source = networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype.source;
      this.protocol = networkAclRulePrototypeNetworkAclRuleProtocolIndividualPrototype.protocol;
    }
    ...
    /**
     * Builds a NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype.
     *
     * @return the new NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype instance
     */
    public NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype build() {
      return new NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype(this);
    }
     ...
     *
     * @param action the action
     * @return the NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype builder
     */
  ...
  protected NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype(Builder builder) {
   ...
   * New builder.
   *
   * @return a NetworkACLRulePrototypeNetworkACLRuleProtocolIndividualPrototype builder
   */
