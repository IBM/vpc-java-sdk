 ...
 */
public class NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype extends NetworkACLRulePrototypeNetworkACLContext {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype instance.
     *
     * @param networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype the instance to initialize the Builder with
     */
    public Builder(NetworkACLRulePrototypeNetworkACLContext networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype) {
      this.action = networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype.action;
      this.destination = networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype.destination;
      this.direction = networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype.direction;
      this.ipVersion = networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype.ipVersion;
      this.name = networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype.name;
      this.source = networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype.source;
      this.protocol = networkAclRulePrototypeNetworkAclContextNetworkAclRuleProtocolIndividualPrototype.protocol;
    }
    ...
    /**
     * Builds a NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype.
     *
     * @return the new NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype instance
     */
    public NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype build() {
      return new NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype(this);
    }
     ...
     *
     * @param action the action
     * @return the NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype builder
     */
  ...
  protected NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype() { }

  protected NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype(Builder builder) {
   ...
   * New builder.
   *
   * @return a NetworkACLRulePrototypeNetworkACLContextNetworkACLRuleProtocolIndividualPrototype builder
   */
