 ...
 */
public class SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype extends SecurityGroupRulePrototype {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype instance.
     *
     * @param securityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype the instance to initialize the Builder with
     */
    public Builder(SecurityGroupRulePrototype securityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype) {
      this.direction = securityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype.direction;
      this.ipVersion = securityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype.ipVersion;
      this.local = securityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype.local;
      this.name = securityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype.name;
      this.remote = securityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype.remote;
      this.protocol = securityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype.protocol;
    }
    ...
    /**
     * Builds a SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype.
     *
     * @return the new SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype instance
     */
    public SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype build() {
      return new SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype(this);
    }
     ...
     *
     * @param direction the direction
     * @return the SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype builder
     */
  ...
  protected SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype(Builder builder) {
   ...
   * New builder.
   *
   * @return a SecurityGroupRulePrototypeSecurityGroupRuleProtocolIndividualPrototype builder
   */
