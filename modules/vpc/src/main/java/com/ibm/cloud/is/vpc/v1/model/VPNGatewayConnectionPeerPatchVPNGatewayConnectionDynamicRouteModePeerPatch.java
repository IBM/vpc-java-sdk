...
/**
 * The peer VPN gateway for this connection. If `peer.type` is `ipv4_address`, only `peer.address` may be specified. If
 ...
 */
public class VPNGatewayConnectionPeerPatchVPNGatewayConnectionDynamicRouteModePeerPatch extends VPNGatewayConnectionPeerPatch {


  protected VPNGatewayConnectionPeerPatchVPNGatewayConnectionDynamicRouteModePeerPatch() { }
}
