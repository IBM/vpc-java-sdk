 ...
 */
public class InstanceClusterNetworkAttachmentCollection extends GenericModel {

  @SerializedName("cluster_network_attachments")
  protected List<InstanceClusterNetworkAttachment> clusterNetworkAttachments;
  ...
  protected InstanceClusterNetworkAttachmentCollection() { }
   ...
   */
  public List<InstanceClusterNetworkAttachment> getClusterNetworkAttachments() {
