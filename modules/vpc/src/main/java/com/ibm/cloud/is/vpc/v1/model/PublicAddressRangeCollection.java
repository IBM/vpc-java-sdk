 ...
 */
public class PublicAddressRangeCollection extends GenericModel {

  protected PageLink first;
  protected Long limit;
  protected PageLink next;
  @SerializedName("public_address_ranges")
  protected List<PublicAddressRange> publicAddressRanges;
  @SerializedName("total_count")
  protected Long totalCount;

  protected PublicAddressRangeCollection() { }
   ...
   */
  public List<PublicAddressRange> getPublicAddressRanges() {
